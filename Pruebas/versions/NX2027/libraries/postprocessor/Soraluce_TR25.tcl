########################## TCL Event Handlers ##########################
#
#  Soraluce_TR25.tcl - 5_axis_dual_head
#
#    This is a 5-Axis Milling Machine With
#     Dual Rotary Heads.
#
#  Created by CRuiz @ Friday, March 13 2026, 12:29:40 +0100
...
# 11-23-2015 szl - Add PB_CMD_spindle_off and PB_CMD__check_block_spindle_on to enhance back counter sinking and deep hole drilling.
# 08-09-2016 lili - Fix ZYX rotation angle calculation issue in DPP_GE_CALCULATE_COOR_ROT_ANGLE. zero resolution was too high.
  ...
  set mom_sys_alt_unit_post_name                "Soraluce_TR25__IN.pui"
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_4th_axis_min_incr                 "1"
  ...
  set mom_kin_5th_axis_max_limit                "45"
  set mom_kin_5th_axis_min_incr                 "1"
  set mom_kin_5th_axis_min_limit                "-225"
...
return
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE tap_break_chip"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_motion\[\$mom_sys_linear_code\]"
   puts $tmp_file "      fifth_axis\[\$mom_out_angle_pos(0)\]"
   puts $tmp_file "      fourth_axis\[\$mom_out_angle_pos(0)\]"
   puts $tmp_file "      F\[\$feed\]"
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE return_home_rotary_both"
   puts $tmp_file "  \{"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE return_home_bc"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_motion\[\$mom_sys_rapid_code\]"
   puts $tmp_file "      fifth_axis\[0\]"
   puts $tmp_file "      fourth_axis\[0\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE rapid_rotary"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_motion\[\$mom_sys_rapid_code\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE post_cycle_set"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_plane\[\$mom_sys_cutcom_plane_code(\$mom_cutcom_plane)\]\\opt"
   puts $tmp_file "      G_motion\[\$mom_sys_cycle_reps_code\]"
   puts $tmp_file "      X\[\$mom_cycle_feed_to_pos(0)\]"
   puts $tmp_file "      Y\[\$mom_cycle_feed_to_pos(1)\]"
   puts $tmp_file "      Z\[\$mom_cycle_feed_to_pos(2)\]"
   puts $tmp_file "      fifth_axis\[\$mom_out_angle_pos(1)\]"
   puts $tmp_file "      fourth_axis\[\$mom_out_angle_pos(0)\]"
   puts $tmp_file "      R\[\$mom_cycle_rapid_to_pos(\$mom_cycle_spindle_axis)\]"
   puts $tmp_file "      F\[\$feed\]"
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE thread_mill"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_motion\[\$mom_sys_linear_code\]"
   puts $tmp_file "      fifth_axis\[\$mom_out_angle_pos(1)\]"
   puts $tmp_file "      fourth_axis\[\$mom_out_angle_pos(0)\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE thread_mill_2"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_motion\[\$mom_sys_linear_code\]"
   puts $tmp_file "      fifth_axis\[\$mom_out_angle_pos(1)\]"
   puts $tmp_file "      fourth_axis\[\$mom_out_angle_pos(0)\]"
   puts $tmp_file "      FMAX\[12000\]"
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycl_def_19_1"
   puts $tmp_file "  \{"
   puts $tmp_file "      Text\[CYCL DEF 19.1\]"
   puts $tmp_file "      fifth_axis\[\$mom_out_angle_pos(1)\]"
   puts $tmp_file "      fourth_axis\[\$mom_out_angle_pos(0)\]"
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_parameters"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_motion\[\$mom_sys_linear_code\]"
   puts $tmp_file "      fifth_axis\[\$mom_out_angle_pos(1)\]"
   puts $tmp_file "      fourth_axis\[\$mom_out_angle_pos(0)\]"
...
#=============================================================
   ...
   CIRCLE_SET
   PB_CMD_set_cycle_plane
   PB_CMD_salida_label_fresado

   MOM_force Once Text I J
   MOM_do_template circular_move
   PB_CMD_suavizado_operacion
...
#=============================================================
   ...
   MOM_do_template cycle_off_off
   PB_CMD_flag_ini_cycle_off
}
...
#=============================================================
  ...
  # Accumulated time should be in minutes.
   ...
   PB_CMD_ATS_pos_seguridad

   if { [PB_CMD__check_block_return_to_reference_point] } {
      MOM_do_template spindle_off
   }
   PB_CMD_desactivar_label_fresado_operacion
   PB_CMD_reset_output_mode
   PB_CMD_reset_variables
   PB_CMD_reset_all_motion_variables_to_zero
   PB_CMD_listado_label_fresado
   PB_CMD_Introducir_comado
   PB_CMD_tiempo_op
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   ...
   PB_CMD_info_hta
   PB_CMD_set_flag_mov_ini
   PB_CMD_cero_operacion
   PB_CMD_giro_C
   PB_CMD_HTA_CAMB_CAB
   PB_CMD_salida_lbl100
   PB_CMD_REFRI
   ...
   PB_CMD_save_RPM
   PB_CMD_tipo_operacion
   PB_CMD_parametros_plane_spatial
   PB_CMD_valores_giro_cabezal

   MOM_force Once M Text
   MOM_do_template plane_spatial_select
   PB_CMD_ATS_ini_move_xy
   PB_CMD_ATS_cycle_389

   if { [PB_CMD__check_block_plane_spatial_2] } {
...
#=============================================================
   ...
   PB_CMD_tipo_avance
   PB_CMD_suavizado_operacion
   PB_CMD_gestion_Z_label_fresado
   PB_CMD_salida_label_fresado
...
#=============================================================
  ...
  global mom_motion_event
   ...
   if { [PB_CMD__check_block_salida_inicial] } {
...
#=============================================================
  ...
  global mom_sys_machine_time mom_machine_time
   ...
   if { [PB_CMD__check_block_CYCL_247] } {
      PB_call_macro CYCL_247
   }
   PB_CMD_preset
   PB_CMD_ATS_SAVE_KINEMATICS
}
...
#=============================================================
   ...
   PB_CMD_info
   PB_CMD_variables_iniciales
   PB_CMD_variables_labels
   PB_CMD_machine_kinematics
   PB_CMD_init_helix
   ...
   PB_CMD_maquina
   MOM_set_seq_on
   PB_CMD_comandos_iniciales
   PB_CMD_uplevel_ROTARY_AXIS_RETRACT
   PB_CMD_uplevel_MOM_user
   PB_CMD_uplevel_MOM_ciclo_32
   PB_CMD_uplevel_MOM_Ciclo_208
   PB_CMD_uplevel_MOM_rapid_move
   PB_CMD_uplevel_MOM_linear_move
   PB_CMD_uplevel_ciclos
   PB_CMD_uplevel_creacion_label_acabado
   PB_CMD_uplevel_creacion_label_fresado
...
#=============================================================
proc PB_CMD_ATS_SAVE_KINEMATICS { } {
#=============================================================
...
#=============================================================
proc PB_CMD_ATS_cycle_389 { } {
#=============================================================
# Procedimiento para sacar el ciclo 389 antes del plane spatial.
# Debido a que en ocasiones la máquina desactiva la funcion de PLANE SPATIAL.
global mom_post_in_simulation
return
if {$mom_post_in_simulation != "CSE"} {
    MOM_output_literal "CYCL DEF 389 Rotar cabezal/pieza ~"
    MOM_set_seq_off
    MOM_output_literal "   Q1508=+1    ;0=Cabezal, 1=Plano ~"
    MOM_output_literal "   Q1509=+0    ;0=NONE, 1=CA, 2=CB"
    MOM_set_seq_on
}
}
...
#=============================================================
proc PB_CMD_ATS_ini_move_xy { } {
#=============================================================
 global mom_out_angle_pos



MOM_force Once G_motion Z_inicial FMAX Z
MOM_output_literal "M128"
MOM_force once X Y
MOM_do_template rapid_xy_mcs
MOM_output_literal "M129"
#MOM_do_template rapid_z_mcs
#MOM_output_literal "0: $mom_out_angle_pos(0) 1: $mom_out_angle_pos(1) $::mom_pos_alt "

#if {($mom_out_angle_pos(0) == -90 && $mom_out_angle_pos(1) == 0) || $::mom_pos_alt == "TRUE" } {return}

if {$::mom_pos_alt == "TRUE" } {return}

MOM_output_literal "L Y250 FMAX M91"

}


#=============================================================
proc PB_CMD_ATS_pos_alt { } {
#=============================================================

global mom_pos_alt mom_pos mom_out_angle_pos mom_alt_pos ats_mom_out_pos mom_post_in_simulation

#MOM_output_literal ";0: $::mom_out_angle_pos(0) 1: $::mom_out_angle_pos(1)"

if {$mom_out_angle_pos(0) > 270 && $mom_out_angle_pos(0) < 360} {set mom_pos_alt "TRUE"}
if {$mom_post_in_simulation == "CSE"} {
    if {$mom_out_angle_pos(0) == 270 && $mom_out_angle_pos(1) == 0} {set mom_pos_alt "TRUE"}
}
#if {$mom_out_angle_pos(0) == 270 && $mom_out_angle_pos(1) == 0} {set mom_pos_alt "TRUE"}

#if {$mom_out_angle_pos(0) > 180 } {set mom_pos_alt "TRUE"}
if { $::mom_pos_alt == "TRUE" } {
    #MOM_output_literal "; $mom_out_angle_pos(0) $mom_out_angle_pos(1)"
    #MOM_output_literal "; $mom_alt_pos(3) $mom_alt_pos(4)"

    set lv_ats_mom_out_pos(0) $mom_alt_pos(3)
    set lv_ats_mom_out_pos(1) $mom_alt_pos(4)

    set ats_mom_out_pos(0) [ATS_ajustar_angulo_B $lv_ats_mom_out_pos(0)]
    set ats_mom_out_pos(1) [ATS_ajustar_angulo_A $lv_ats_mom_out_pos(1)]
    ...
    #MOM_reload_kinematics
    #MOM_output_literal "; $ats_mom_out_pos(0) $ats_mom_out_pos(1)"
}
...
#=============================================================
proc PB_CMD_ATS_pos_alt_old { } {
#=============================================================

global mom_pos_alt mom_pos mom_out_angle_pos


if { $::mom_pos_alt == "TRUE" } {
MOM_output_literal "; $mom_out_angle_pos(0) $mom_out_angle_pos(1)"
    set mom_out_angle_pos(0) [expr $mom_out_angle_pos(0) - 180]

    if { $mom_out_angle_pos(1) >= "0" &&  $mom_out_angle_pos(1) <= "180"  } {
        set mom_out_angle_pos(1) [expr $mom_out_angle_pos(1) - 180]
    } else {
        set mom_out_angle_pos(1) [expr (-180 - $mom_out_angle_pos(1))]
    }
    set mom_pos(3) $mom_out_angle_pos(0)
    set mom_pos(4) $mom_out_angle_pos(1)
    MOM_reload_variable -a mom_pos
...
#=============================================================
proc PB_CMD_ATS_pos_seguridad { } {
#=============================================================
global mom_out_angle_pos mom_current_oper_is_last_oper_in_program
global mom_nxt_out_angle_pos


#MOM_output_literal "0: $mom_out_angle_pos(0) 1:$mom_out_angle_pos(1)"
#MOM_output_literal "$mom_nxt_out_angle_pos(0) $mom_nxt_out_angle_pos(1)"
if {$mom_current_oper_is_last_oper_in_program == "YES"} {return}


#if {$mom_out_angle_pos(0) == -90 && $mom_out_angle_pos(1) == 0} {}

if {$mom_out_angle_pos(0) >= -90 && $mom_out_angle_pos(0) <= -45} {
    MOM_output_literal "L Z1300 FMAX M91"
}
MOM_output_literal "L Y250 FMAX M91"
...
#=============================================================
proc PB_CMD_ATS_warning_SPA { } {
#=============================================================
global dpp_ge mom_operation_name

if {$dpp_ge(coord_rot_angle,0) > 30 && $dpp_ge(coord_rot_angle,1) == 0 && $dpp_ge(coord_rot_angle,2) == 0} {
    set r [MOM_display_message "SPA mayor a 30 en la operacion $mom_operation_name. ¿Desea continuar?" "Aviso Valor SPA" W "SI" "NO"]
...
#=============================================================
proc PB_CMD_CAMBIO_HTA { } {
#=============================================================
global mom_post_in_simulation mom_tool_number mom_spindle_speed
#PB_CMD_parada_opcional
if { $mom_post_in_simulation == "CSE"} {
    MOM_output_literal "TOOL CALL $mom_tool_number Z S$mom_spindle_speed"
} else {
    MOM_force Once Text T Text S Text
...
#}
PB_CMD_detectar_cambio_herramienta
#MOM_output_literal "L X0 FMAX"
MOM_output_literal "M328"
}
...
##########################################################################
#
# Este comando personalizado nos permitira sacar el CYCL DEF 32 en
# función de que nosotros lo activemos al comienzo de la operacion
# El formato del ciclo de tolerancia es el siguiente:
#
#     CYCL DEF 32.0 TOLERANCIA
#     CYCL DEF 32.1 T(valor de tolerancia de calculo)
#     CYCL DEF 32.2 HSC-MODE:$hsc_mode
##########################################################################

global mom_Activar_tol_32 mom_valor_tol mom_hsc mom_post_in_simulation
#MOM_output_literal "$mom_Activar_tol_32"
if [info exists mom_Activar_tol_32] {
  if { $mom_Activar_tol_32 == "ACTIVE" } {
        set val_tol [format "%2.2f" $mom_valor_tol]
        set HSC $mom_hsc
        #desbastes
        #if { $val_tol >= "0.1" } {
        #    set HSC "1"
        #    set ciclo392_Q240 "+1"
        #semiacabados
        #} elseif { ($val_tol < "0.1") && ($val_tol > "0.03") } {
        #    set HSC "1"
        #    set ciclo392_Q240 "+2"
        #acabados
        #} elseif { $val_tol <= "0.03" } {
     ...
     if { $mom_post_in_simulation != "CSE" } {
        #ciclo 392 alata velocidad
        #MOM_output_literal "CYCL DEF 392 palett setup ~"
        #MOM_output_literal "    Q240=$ciclo392_Q240   ;Process Mode ~"
        #MOM_output_literal "    Q241=+2    ;Default Weight"
        #ciclo 32 tolerancia
        MOM_output_literal "CYCL DEF 32.0 TOLERANCE"
        MOM_output_literal "CYCL DEF 32.1 T$val_tol"
        MOM_output_literal "CYCL DEF 32.2 HSC-MODE: $HSC"
    }
  }
}
...
#=============================================================
proc PB_CMD_CYCL_397 { } {
#=============================================================
global B A C
global mom_sel_cabezal mom_Cinematica mom_post_in_simulation mom_out_angle_pos
global mom_out_angle_pos mom_alt_pos mom_tool_axis mom_mcs_goto mom_pos dpp_ge
global mom_prev_mcs_goto mom_prev_pos mom_kin_arc_output_mode mom_kin_helical_arc_output_mode
global mom_arc_center mom_pos_arc_center
#MOM_output_literal "mom_tool_axis(0) $::mom_tool_axis(0) mom_tool_axis(1) $::mom_tool_axis(1)"
#if { $mom_tool_axis(1) > "0.999" } {

#return

#    MOM_output_literal "CYCL DEF 397 CICLO CABEZAL ~"
#    MOM_set_seq_off
#    MOM_output_literal "   Q1507=90 ; DEGRES ART. VERT. ~"
#    MOM_output_literal "   Q1506=-90 ; DEGRES ART. DIAG. "
#    MOM_set_seq_on

#} elseif { $mom_tool_axis(0) <= "-0.999" } {

    #MOM_output_literal "CYCL DEF 397 CICLO CABEZAL ~"
    #MOM_set_seq_off
    #MOM_output_literal "   Q1507=+90 ; DEGRES ART. VERT. ~"
    #MOM_output_literal "   Q1506=-180 ; DEGRES ART. DIAG. "
    #MOM_set_seq_on
...
if { $::mom_pos_alt == "TRUE" } {return}
    MOM_output_literal "CYCL DEF 397 CICLO CABEZAL ~"
    MOM_set_seq_off
    MOM_output_literal "   Q1507=$B ; DEGRES ART. VERT. ~"
    MOM_output_literal "   Q1506=$A ; DEGRES ART. DIAG. "
    MOM_set_seq_on
#}
}
...
# Define feedrate in variables
  ...
  if { [info exists mom_siemens_feed_definition] && $mom_siemens_feed_definition == "ON" } {
     if { $mom_motion_type != "CYCLE" } {
        ...
        #PB_CMD_define_feedrate_format_drill
     }
  }  else {
      #MOM_output_literal "---------> Velocidades normales"
...
#=============================================================
proc PB_CMD_HTA_CAMB_CAB { } {
#=============================================================
  global flag_cambio_cab
#if { $flag_cambio_cab == "1" } {
global mom_post_in_simulation mom_tool_number mom_spindle_speed
#PB_CMD_parada_opcional
if { $mom_post_in_simulation == "CSE"} {
...
#=============================================================
proc PB_CMD_Introducir_comado { } {
#=============================================================
global flag_introducir_comando mom_introducir_comando i_com introducir_comando

if { $flag_introducir_comando == 1 } {
    for { set i 0 } { $i < $i_com } { incr i } {
        MOM_output_literal "$introducir_comando($i)"
    }
    set flag_introducir_comando 0
    set i_com 0
    #set introducir_comando 0
}
}
...
MOM_output_to_listing_device " --------------- $mom_kin_machine_type"
...
if 1 {
   ...
   if { $axis == 3 } {
      ...
      if { ![string compare "OFF" $mom_rotation_reference_mode] } {
         ...
         global mom_pos_alt ;    set mom_pos_alt "TRUE"
         set mom_kin_rotary_axis_method "PREVIOUS"
         MOM_reload_kinematics
      }
...
#=============================================================
proc PB_CMD_Puntos_label { } {
#=============================================================
################################################
#
# Con este procedimiento escribiremos los
# puntos del label en un fichero aparte para
# posteriormente copiar el contenido al
# final del programa de mecanizado
#
################################################

global mom_label
global mom_nombre
global puntos_taladrado
global mom_group_name
global mom_output_label
global mom_output_file_full_name
global mom_output_file_directory
global linea
global taladros_label
global mom_alt_pos
set extension ".h"

if { [ info exists mom_label ] && [info exists puntos_taladrado]} {
    if { ($mom_label =="TRUE") && ($puntos_taladrado =="1") } {

    MOM_close_output_file "$mom_output_file_full_name"
    MOM_open_output_file "$mom_output_file_directory$mom_group_name$extension"

    set mom_alt_pos(0) [format "%3.2f" $mom_alt_pos(0)]
    set mom_alt_pos(1) [format "%3.2f" $mom_alt_pos(1)]
    #set mom_alt_pos(2) [format "%3.2f" $mom_alt_pos(2)]

    MOM_set_seq_off
    MOM_output_literal "L X$mom_alt_pos(0) Y$mom_alt_pos(1) F MAX M99"
    MOM_set_seq_on
...
#######################################################
#
# Este comando nos servira para delimitar el tipo de
# refrigeracion que deseemos activar o desactivar
#
#####################################################


global mom_Tipo_ref refri flag_refri
if {[info exists mom_Tipo_ref]  && ($mom_Tipo_ref != "DESACTIVAR") } {
    if { $mom_Tipo_ref == "INTERNA" } { set refri "7" }
    if { $mom_Tipo_ref == "EXTERNA" } { set refri "8" }
    if { $mom_Tipo_ref == "DESACTIVAR" } { set refri "9" }
}
...
#=============================================================
proc PB_CMD__check_block_CYCL_247 { } {
#=============================================================
# This custom command should return
#   1 : Output
#   0 : No output
...
#=============================================================
proc PB_CMD__check_block_CYCL_397 { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output

global mom_sel_cabezal
if { ($mom_sel_cabezal == "DIRECTO") || ($mom_sel_cabezal == "SIN_CABEZAL") } {
return 0
} else {
return 1
}
...
global mom_kin_4th_axis_leader mom_kin_5th_axis_leader
global save_4th save_5th

if { ($save_4th == $mom_kin_4th_axis_leader) && ($save_5th == $mom_kin_5th_axis_leader) } {
    return 0
} else {
    return 1
}
...
#=============================================================
proc PB_CMD__check_block_cab_directo { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
...
if { $mom_sel_cabezal == "AUTOMATICO" } {
    return 1

} elseif { ($mom_sel_cabezal == "DIRECTO") } {
    return 0
}
}
...
global sup_puntos_tal
global mom_oper_geom
global map_tal

if {[info exists map_tal($mom_oper_geom) ]} {
    if {[info exists sup_puntos_tal($map_tal($mom_oper_geom)) ]} {
            if {$sup_puntos_tal($map_tal($mom_oper_geom)) == "1"} {
                return 0
               }
       }
}
...
#=============================================================
proc PB_CMD__check_block_label { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
...
#=============================================================
proc PB_CMD__check_block_label_mill_2 { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
...
global cm_label_mill
global mom_motion_event
global mom_motion_type

if { $cm_label_mill =="1" } {

    if {($mom_motion_event == "initial_move") || $mom_motion_type == "DEPARTURE" } {
...
global mom_fin_op
    ...
    if { $mom_fin_op == "TRUE"} {
       ...
       MOM_output_literal "estoy aquiiiii"
       return 1
        }
set $mom_fin_op    "FALSE"
...
#=============================================================
proc PB_CMD__check_block_m140_1 { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
...
#=============================================================
proc PB_CMD__check_block_plane_reset { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
...
#=============================================================
proc PB_CMD__check_block_plane_spatial_1 { } {
#=============================================================
# This custom command should return
#   1 : Output
#   0 : No output

   global mom_post_in_simulation mom_tool_axis
...
#=============================================================
proc PB_CMD__check_block_plane_spatial_2 { } {
#=============================================================
# This custom command should return
#   1 : Output
#   0 : No output
...
#=============================================================
proc PB_CMD__check_block_return_home_xy { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
...
#=============================================================
proc PB_CMD__check_block_return_home_xy_1 { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
...
#=============================================================
proc PB_CMD__check_block_return_home_z { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
...
#=============================================================
proc PB_CMD__check_block_return_home_z_1 { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
...
#   0 : No output
  ...
  global mom_pos mom_prev_pos mom_out_angle_pos mom_prev_out_angle_pos
  global dpp_ge mom_cambio_plano inicio_seguridad mom_ini_op mom_current_motion

    if {$mom_current_motion == "first_move" && $mom_ini_op == "TRUE"} {
         return 0
    } else {
         return 1
    }
    set $mom_ini_op    "FALSE"
  ...
  } elseif {($dpp_ge(coord_rot)!="NONE") && ($inicio_seguridad == 1)} {
      return 1
  } else {
      return 0
  }
...
#   0 : No output
   ...
   global mom_current_motion flag_mov_ini

if { $flag_mov_ini == 1 } { return 0 }
...
#=============================================================
proc PB_CMD__check_block_salida_inicial { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
...
#=============================================================
proc PB_CMD__check_block_spindle_on { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
#
# This command is used to avoid to trigger spindle for some operation.
# i.e. Deep Hole Drilling, Back Countersinking.
#
# 2015-11-23 szl - Initial implementation
...
#=============================================================
proc PB_CMD_add_fixture { } {
#=============================================================
# ################################################################
#
# Comando personalizado para sacar los label de origen teoricos
#
# ################################################################

    global mom_invisible_mcs_array
    global mom_mcs_info
    global angulo
    global angulo_save
    set RAD2DEG [expr 90.0 / asin(1.0)]
    global cero_pieza
    global cero_incr  ; set cero_incr 204

    for { set i 0 } { $i < 20 } { incr i 1 } {
        if {[info exist mom_invisible_mcs_array($i)]  } {
            #Tengo que descartar los desplazamientos de ceros, leo tres primeros caracteres del nombre del cero
            set nombre [string range $mom_invisible_mcs_array($i) 0 2]

            if {$nombre != "SPA"} {
                #set cero_real $mom_mcs_info($mom_invisible_mcs_array($i),offset_val)
                #MOM_output_literal "Valor de cero real: $cero_real"

                ############################ Calculo del angulo ############################
                #
                # Cos es positivo [0,90] o [270,0], Cos negativo [90,180] o [180,270]
                # Sen es positivo [0,90] o [90,180], Sen es negativo [90,180] o [180,270]
                #
                #                                |
                #                                |
                #             (-,+)              |        (+,+)
                ...
                #
                #
                # Detectar en que cuadrante estoy trabajando para sacar el suplementario
                #
                ################################################################################

                ### Calculo inicial C ###
                set angulo [expr acos($mom_mcs_info($mom_invisible_mcs_array($i),xvec,0))]
                set angulo [expr $angulo * $RAD2DEG]
                #MOM_output_literal "Angulo de C:$angulo"

                if { $mom_mcs_info($mom_invisible_mcs_array($i),xvec,0) > -0.01 } {
                #Estoy en el primer o 4 cuadrante

                    if {$mom_mcs_info($mom_invisible_mcs_array($i),zvec,0) > -0.01} {
                        #Estoy en el primer cuadrante, el angulo es correcto
                        #MOM_output_literal "Cuadrante 1
                    } else {
                        #Estoy en el cuarto cuadrante, debo restar a 360 el angulo
                        #MOM_output_literal "Cuadrante 4"
                        set angulo [expr 360 - ($angulo)]
                    }
                } else {
                #Estoy en el segundo o tercer cuadrante
                    if {$mom_mcs_info($mom_invisible_mcs_array($i),zvec,0) > -0.01} {
                        #Estoy en el segundo cuadrante, el angulo es correcto
                        #MOM_output_literal "Cuadrante 2"
                    } else {
                        #Estoy en el tercer cuadrante, debo sumarle 180 grados
                        #MOM_output_literal "Cuadrante 3"
                        set angulo [expr 180 + ($angulo)]
                    }
                }

                #MOM_output_literal "Angulo de C retocado:$angulo"
                set angulo [format "%3.3f" $angulo]

                switch -exact $angulo {
                    "0.000" {
                        set cero_pieza($i,0.000) 201
                        #MOM_output_literal "Valor en 0; $cero_pieza($i,0.000)"
                    }
                    "90.000" {
                        set cero_pieza($i,90.000) 202
                        #MOM_output_literal "Valor en 90; $cero_pieza($i,90.000)"
                    }
                    "180.000" {
                        set cero_pieza($i,180.000) 203
                        #MOM_output_literal "Valor en 180; $cero_pieza($i,180.000)"
                    }
                    "270.000" {
                        set cero_pieza($i,270.000) 204
                        #MOM_output_literal "Valor en 270; $cero_pieza($i,270.000)"
                    }
                    default {
                        incr cero_incr
                        set cero_pieza($i,$angulo) $cero_incr
                        #MOM_output_literal "Valor en $angulo; $cero_pieza($i,$angulo)"
                    }
                }

                set x_cero [format "%4.3f" $mom_mcs_info($mom_invisible_mcs_array($i),org,0)]
                #Cambiado por petición de Ander 30/05/16
                set y_cero [format "%4.3f" $mom_mcs_info($mom_invisible_mcs_array($i),org,1)]
                #set y_operario [format "%4.3f" $mom_mcs_info($mom_invisible_mcs_array(0),org,1)]
                #set y_cero [expr ($mom_mcs_info($mom_invisible_mcs_array($i),org,1)) - ($mom_mcs_info($mom_invisible_mcs_array(0),org,1))]
                set y_cero [format "%4.3f" $y_cero]
                set z_cero [format "%4.3f" $mom_mcs_info($mom_invisible_mcs_array($i),org,2)]

                #MOM_output_literal "Y=>>>> $y_cero"

                #MOM_output_literal ";=============================="
                #set valor_label [expr (200 + $cero_real)]
                #set valor_label $cero_pieza($i,$angulo)
                set valor_label [expr (1 + $i)]

                #MOM_output_literal "LBL $cero_pieza($i,$angulo)"
                #MOM_output_literal "* - LBL $cero_pieza($i,$angulo) DISTANCIA TEORIKA ORIGEN $mom_invisible_mcs_array($i) "
                #MOM_output_literal ";C$angulo"
                #MOM_output_literal ";"
                #MOM_output_literal "Q11 = $x_cero     ;DEKALAJE EJE \"X\" en B$angulo "
                #MOM_output_literal "Q12 = $y_cero     ;DEKALAJE EJE \"Y\" en B$angulo"
                #MOM_output_literal "Q13 = $z_cero     ;DEKALAJE EJE \"Z\" en B$angulo"
                #MOM_output_literal "Q41 = Q4 ; DEKALAJE EJE \"C\" en C$angulo"
                #MOM_output_literal "Q51 = 0 ;DEKALAJE EJE \"V\" en C$angulo"
                #MOM_output_literal "Q40 = $angulo; GIRO DE MESA"
                #MOM_output_literal "FN 11: IF + Q9 GT +0 GOTO LBL $valor_label"
                #MOM_output_literal "Q3 = Q3 - Q13"
                #MOM_output_literal "LBL $valor_label"
                #MOM_output_literal "Q13 = Q13 + Q3"
                #MOM_output_literal "Q9 = Q9 + 1"
                #if {$valor_label == "201"} {MOM_output_literal "Q18 = Q11"}
                #if {$valor_label == "201"} {MOM_output_literal "Q19 = Q13"}
                #MOM_output_literal "LBL 0"
                #MOM_output_literal "FN 9: IF +1 EQU +1 GOTO LBL 210"
                #MOM_output_literal ";"

                set angulo_save($i) $angulo
            }
        }
    }
...
#=============================================================
proc PB_CMD_add_preset { } {
#=============================================================
# ###########################################################################################
#
# Comando personalizado para sacar los preset en la cabecera del programa
#
# ###########################################################################################

    #MOM_output_literal ";"
    #MOM_output_literal "LBL 210"
    #MOM_output_literal "Q18 = Q11"
    #MOM_output_literal "Q19 = Q12"
    #MOM_output_literal ";=============================="
    #MOM_output_literal "* - ORIGENAK SARTU TABLA PRESET"
    #MOM_output_literal ";"
    #MOM_output_literal ";C0 ----------"
    #MOM_output_literal "CALL LBL 201 ;DISTANCIA TEORIKA ORIGEN C0"
    #MOM_output_literal ";"
    #MOM_output_literal ";CALCULO DISTANCIA X Y"
    #MOM_output_literal "LBL 216"
    #MOM_output_literal "Q31 = Q2 - Q19 + Q5"
    #MOM_output_literal "Q10 = Q11 + (Q1 - Q18); DIST X AL ANGULO"
    #MOM_output_literal "Q30 = Q12 + Q31; DIST Y AL ANGULO"
    #MOM_output_literal ";"
    #MOM_output_literal "Q15 = Q10 * COS Q40 - Q30 * SIN Q40"
    #MOM_output_literal "Q35 = (Q30 * COS Q40 + Q10 * SIN Q40) - Q51"
    #MOM_output_literal "LBL 0"

    #Introducción de los valores de preset
    ...
    for { set i 0 } { $i < 10 } { incr i 1 } {
        if {[info exist mom_invisible_mcs_array($i)]  } {
            ...
            ################################################################################
                ...
                set x_operario [format "%4.3f" $mom_mcs_info($mom_invisible_mcs_array($i),org,0)]
                set y_operario [format "%4.3f" $mom_mcs_info($mom_invisible_mcs_array($i),org,1)]
                set z_operario [format "%4.3f" $mom_mcs_info($mom_invisible_mcs_array($i),org,2)]

                #set valor_preset $cero_real
                if {$i > 0} {
                    #MOM_output_literal ";C$angulo"
                    #set valor_label [expr (200 + $cero_real)]
                    #MOM_output_literal "CALL LBL $cero_pieza($i,$angulo) ; DISTANCIA TEORICA EN ORIGEN B$angulo"
                    #MOM_output_literal ";"
                    #MOM_output_literal "CALL LBL 216 ; CALCULO DISTANCIA X Z"
                    #MOM_output_literal ";"
                }

                #MOM_output_literal "CYCL DEF 385 CICLO DE PRESET ~"
                #MOM_set_seq_off
                #set valor_preset [expr ($cero_pieza($i,$angulo)- 200)]
                #MOM_output_literal "  Q370 = $valor_preset ;NUMERO TABLA PRESET ~ "
                #MOM_output_literal "  Q371 = +Q15 ;CERO EJE X ~"
                #MOM_output_literal "  Q372 = +Q12 ;CERO EJE Y ~"
                #MOM_output_literal "  Q373 = +Q35 ;CERO EJE Z ~"
                #MOM_output_literal "  Q374 = +Q41 ;CERO EJE B ~"
                #MOM_output_literal "  Q375 = +Q51 ;CERO EJE W"
                #MOM_set_seq_on
                #MOM_output_literal ";"

                #MOM_output_literal "CYCL DEF 385 PRESET ~"
                MOM_set_seq_off
                set valor_preset [expr ($cero_pieza($i,$angulo)- 200)]
                #MOM_output_literal "  Q1569 = +Q15  ;DESPLAZAMIENTO EN X ~"
                #MOM_output_literal "  Q1570 = +Q13  ;DESPLAZAMIENTO VERTICAL (Z) ~"
                #MOM_output_literal "  Q1571 = +Q35  ;DESPLAZAMIENTO RAM (Y) ~"
                #MOM_output_literal "  Q1572 = +Q41  ;DESPL. EJE ROTATORIO MESA (C) ~"
                #MOM_output_literal "  Q1573 = +Q51  ;DESPL. EJE TRASLACIÓN MESA (V) ~"
                #MOM_output_literal "  Q1574 = $valor_preset  ;NUMERO LINEA PRESET"
                MOM_set_seq_on
                #MOM_output_literal ";"
    ...
    #MOM_output_literal ";"
    #MOM_output_literal ";"
    #MOM_output_literal "L W-500 R0 FMAX M91"
    #MOM_output_literal "L V+1000 R0 FMAX M91"
    #MOM_output_literal ";"
    #MOM_output_literal ";"
    #MOM_output_literal ";"
    #MOM_output_literal "*"
     #   MOM_do_template nombre_cabezal
     #   MOM_do_template cycl_def_390
     #   MOM_set_seq_off
     #   MOM_do_template param_Q1534
     #   MOM_set_seq_on
     #   MOM_output_literal "*"
     #   MOM_output_literal ";"
    #MOM_output_literal ";"
...
proc PB_CMD_avisos { } {
#=============================================================
global mom_tool_pitch mom_pos mom_out_angle_pos mom_current_motion mom_tool_name

if { $mom_current_motion == "initial_move" } {
if { [info exists mom_tool_pitch] && $mom_tool_pitch == "0"} {

MOM_display_message    "Paso de rosca igual 0 en la herramienta $mom_tool_name" "AVISO" "E"
}
}
set mom_pos(3) [format "%.1f" $mom_pos(3)]
set mom_pos(4) [format "%.1f" $mom_pos(4)]
set ceil_b [expr ceil($mom_pos(3))]
set ceil_a [expr ceil($mom_pos(4))]

if { $ceil_b != $mom_pos(3) || $ceil_a != $mom_pos(4)} {

MOM_display_message    "Valor de giros de cabezal son B= [format "%3.1f" $mom_pos(3)] A= [format "%3.1f" $mom_pos(4)]" "VALORES NO ENTEROS EN EL GIRO DE CABEZAL" "E"
...
#=============================================================
proc PB_CMD_calculo_C_auto { } {
#=============================================================
global C mom_post_in_simulation
global mom_decalaje_x    ; set x [format "%.2f" $mom_decalaje_x]
global mom_decalaje_ram  ; set ram [format "%.2f" $mom_decalaje_ram]
global mom_decalaje_vert ; set vert [format "%.2f" $mom_decalaje_vert]
global mom_q1585        ; set q1585 $mom_q1585
global mom_pos_mesa      ; set mesa [format "%.2f" $mom_pos_mesa]
global mom_pos_seg       ; set seg [format "%.2f" $mom_pos_seg]
global mom_q1587        ; set q1587 $mom_q1587
global save_c
...
global mom_mcs_info
global RAD2DEG
global save_fijacion
global mom_csys_matrix
#MOM_output_to_listing_device " ---------------------- mom_csys_matrix ----------------------------------"
#MOM_output_to_listing_device "(    $mom_csys_matrix(0)    $mom_csys_matrix(1)    $mom_csys_matrix(2)   )"
#MOM_output_to_listing_device "(    $mom_csys_matrix(3)    $mom_csys_matrix(4)    $mom_csys_matrix(5)   )"
#MOM_output_to_listing_device "(    $mom_csys_matrix(6)    $mom_csys_matrix(7)    $mom_csys_matrix(8)   )"

set cero $mom_mcsname_attach_opr($mom_operation_name)
# ########################### CALCULOS ###############################
set csys3 [format "%.2f"  $mom_csys_matrix(3)]
#MOM_output_to_listing_device "$csys3"

if { $csys3 == "0.00" } {
### Calculo B ###
set angulo [expr acos($mom_mcs_info($cero,xvec,0))]
set angulo [expr $angulo * $RAD2DEG]
#MOM_output_literal "Angulo de C:$angulo $mom_mcs_info($cero,xvec,0) $mom_mcs_info($cero,yvec,0) $mom_mcs_info($cero,zvec,0)"

set xvect [format "%.2f" $mom_mcs_info($cero,xvec,0)]
set yvect [format "%.2f" $mom_mcs_info($cero,yvec,0)]
set zvect [format "%.2f" $mom_mcs_info($cero,zvec,0)]
#MOM_output_literal "$xvect -- $yvect -- $zvect"
if { $xvect > 0.00 } {
#Estoy en el primer o 4 cuadrante
...
#Estoy en el segundo o tercer cuadrante
    if { $zvect > 0.00 } {
        ...
        #MOM_output_literal "Cuadrante 3"
        if { ($zvect > -0.01) && ($yvect < 0.01)} {
        } else {
        }
        set angulo [expr asin($mom_mcs_info($cero,zvec,0))]
        set angulo [expr $angulo * $RAD2DEG]
        set angulo [expr 180 + $angulo]
    } else {
        #Estoy en el tercer cuadrante
...
#Estoy en el segundo o tercer cuadrante
    if { $yvect > 0.00 } {
        #Estoy en el tercer cuadrante
        MOM_output_literal "Cuadrante 3"
        if { ($xvect > -0.01) && ($yvect < 0.01)} {
        } else {
        }
        set angulo [expr asin($mom_mcs_info($cero,yvec,0))]
        set angulo [expr $angulo * $RAD2DEG]
        set angulo [expr 180 + $angulo]
    } else {
        #Estoy en el tercer cuadrante
...
set angulo [format "%3.3f" $angulo]
#set save_fijacion $fijacion
if { $angulo == "360.000" } { set angulo "0.000" }

global C
set C $angulo

#MOM_output_literal "$save_c != $C"
if { $save_c != $C } {
PB_CMD_parada_opcional
#MOM_output_literal "L V+$seg FMAX"
MOM_output_literal "PLANE RESET STAY"
MOM_output_literal "; QUE NO PEGUE AL GIRAR"

if { $mom_post_in_simulation == "CSE" } { MOM_output_literal "L C$C R0 FMAX" }

MOM_output_literal "CYCL DEF 322 COMP GIRO MESA ~"
MOM_set_seq_off
MOM_output_literal "  Q1584 = $C  ;POS. GIRO MESA ~"
MOM_output_literal "  Q1569 = $x  ;DECALAJE EN X ~"
MOM_output_literal "  Q1571 = $ram  ;DECALAJE EN EJE RAM ~"
MOM_output_literal "  Q1570 = $vert  ;DECALAJE VERTICAL ~"
MOM_output_literal "  Q1568 = $q1585  ;0:OFF, 1:ON ~"
MOM_output_literal "  Q1585 = $mesa  ;POSICION LINEAL DE LA MESA ~"
MOM_output_literal "  Q1586 = $seg  ;MOVER A POSICION SEGURA ~"
MOM_output_literal "  Q1587 = $q1587 ;0,1,2"
MOM_set_seq_on
}
global save_c
set save_c $C
...
#=============================================================
proc PB_CMD_cambio_fichero { } {
#=============================================================
#################################################################
#
# Comando para redirigir la salida de los puntos del taladro
#
#################################################################
...
if { [ info exists mom_label ] } {
    ...
    MOM_close_output_file "$mom_output_file_directory$mom_group_name$extension"
    MOM_open_output_file "$mom_output_file_full_name"

    }
   }

set puntos_taladrado "0"
...
#=============================================================
proc PB_CMD_cancelar_label_tal { } {
#=============================================================
#####################################################################
#
# Comando personalizado para salir del label cuando sea necesario
#
#####################################################################

# 1º Declaro variables

global mom_flag_label_tal
global mom_num_label_tal
global mom_oper_geom
global map_tal
global sal_tal
global sup_puntos_tal

# 2º Reviso si existe label asociado a dicha geometria

if {[info exists map_tal($mom_oper_geom) ]} {
    if {[info exists sal_tal($map_tal($mom_oper_geom)) ]} {
    # 3º Examino si debo salir del label
            switch -exact -- $sal_tal($map_tal($mom_oper_geom)) {
                0 {
                  }
                1 {
                    if {$sup_puntos_tal($map_tal($mom_oper_geom)) != 1} {
                            MOM_output_literal "LBL 0"
                            # -----------------------------------
                            #MOM_enable_address Z
                            #MOM_force once G_motion Z_inicial Z
                            #MOM_do_template retract_label_tal_Z
                            #------------------------------------
                       }
                   set sup_puntos_tal($map_tal($mom_oper_geom)) 1
                   set sal_tal($map_tal($mom_oper_geom)) 2
                  }
                2 {
                  }
                default {
                         MOM_output_literal ";Error en label de taladro"
                        }
            }
    }
}
...
#=============================================================
proc PB_CMD_cero_operacion { } {
#=============================================================
# #################################################################
# Comando personalizado para sacar el cero de la operacion
# al inicio de cada operación.
# Pedido solo cuando cambie el sistema de coordenadas
#
# 1º Giro de mesa
# 2º Llamada CYCL DEF 247 FIJAR PTO. REF.
# 3º Mesa hacia atras
# 4º Giro de mesa
#
# #################################################################
    global mom_operation_name mom_mcsname_attach_opr mom_mcs_info
    global RAD2DEG save_fijacion mom_template_subtype flag_cambio_cab
# ########################### LIMITACION ##########################
    if { $mom_template_subtype == "MILL_CONTROL"} {
        MOM_abort_event
    } else {
...
# ########################### CALCULOS ###############################
    ### Calculo cero ###
    set cero $mom_mcsname_attach_opr($mom_operation_name)
    set fijacion $mom_mcs_info($cero,offset_val)
...
# ####################################################################
    ...
    #MOM_output_literal "*"
    #MOM_output_literal "; ========================="
    #MOM_output_literal ";*    GIRO DE MESA $angulo"
    #MOM_output_literal "; ========================="
    #MOM_output_literal "*"
    #MOM_output_literal ";"
    ...
    #2º Llamada CYCL DEF 247
    if { $flag_cambio_cab == "1" } { MOM_output_literal "CYCL DEF 247 FIJAR PUNTO DE REFERENCIA Q339=+$fijacion " }
    #MOM_output_literal ";"
    #MOM_output_literal ";"

    #3º Mesa hacia atras
    #MOM_output_literal "L V+1000 FMAX M91"

    #4º Giro de mesa
    #MOM_output_literal ";L C$angulo FMAX"
    #global C
    #set C $angulo
...
# ########################### CALCULOS ###############################
    ...
    if { $mom_mcs_info($cero,xvec,0) < 0.01 } {
    #Estoy en el primer o 4 cuadrante

        if {$mom_mcs_info($cero,yvec,0) > -0.01} {
            #Estoy en el primer cuadrante
            #MOM_output_literal "Cuadrante 1"
    ...
    #Estoy en el segundo o tercer cuadrante
        if {$mom_mcs_info($cero,yvec,0) < 0.01} {
            ...
            #MOM_output_literal "Cuadrante 3"
            set angulo [expr 180 + (-1)*$angulo]

        } else {
            #Estoy en el tercer cuadrante
            #MOM_output_literal "Cuadrante 2"
            set angulo [expr 90 + ($angulo)]
        }
    }
...
# ####################################################################
    ...
    #2º Llamada CYCL DEF 247
    MOM_output_literal "CYCL DEF 247 FIJAR PUNTO DE REFERENCIA Q339=+$fijacion "
    #MOM_output_literal ";"
    #MOM_output_literal ";"
...
#=============================================================
proc PB_CMD_cero_pieza_operario { } {
#=============================================================
# #########################################################################################
#
# Comando personalizado para sacar el cero pieza del operario
#
# #########################################################################################
...
set x_operario [format "%4.3f" $mom_mcs_info($mom_invisible_mcs_array(0),org,0)]
set y_operario [format "%4.3f" $mom_mcs_info($mom_invisible_mcs_array(0),org,1)]
set z_operario [format "%4.3f" $mom_mcs_info($mom_invisible_mcs_array(0),org,2)]
...
return
        ...
        MOM_output_literal ";"
        MOM_output_literal ";==================================="
        MOM_output_literal "* - C0 ORIGENAK SARTU OPERARIOAK"
        MOM_output_literal ";TABLA PRESET SIGNOA ALDATU"
        MOM_output_literal ";C0"
        MOM_output_literal ";"
        MOM_output_literal "Q1 = $x_operario    ;DEKALAJE EJE \"X\" en C0"
        MOM_output_literal "Q2 = $y_operario    ;DEKALAJE EJE \"Y\" en C0"
        MOM_output_literal "Q3 = $z_operario    ;DEKALAJE EJE \"Z\" en C0"
        MOM_output_literal "Q6 = 0 ; ANGULO EN EL QUE SE COJE"
        MOM_output_literal "Q4 = 0    ;DEKALAJE EJE \"C\" en C0"
        MOM_output_literal "Q5 = 0     ;DEKALAJE EN \"V\" EN C0"
        MOM_output_literal "Q9 = 0 ; KONTADORA Y KO KALKULOA ONDO EGITEKO"
        MOM_output_literal ";"
        MOM_output_literal "Q8 = Q1"
        MOM_output_literal "Q2 = Q2  + Q5"
        MOM_output_literal "Q5 = 0"
        MOM_output_literal "Q1 = Q1 * COS Q6 + Q2 * SIN Q6"
        MOM_output_literal "Q2 = Q2 * COS Q6 + Q8 * SIN Q6"
        MOM_output_literal ";"
        MOM_output_literal ";"
        MOM_output_literal "; SALTOAK ANGULOAREN ARABERA"
        MOM_output_literal ";"
        MOM_output_literal " FN 9: IF +Q6 EQU +0 GOTO LBL 201"
        MOM_output_literal " FN 9: IF +Q6 EQU +90 GOTO LBL 202"
        MOM_output_literal " FN 9: IF +Q6 EQU +180 GOTO LBL 203"
        MOM_output_literal " FN 9: IF +Q6 EQU +270 GOTO LBL 204"
        MOM_output_literal ";"
        MOM_output_literal ";==================================="
...
#=============================================================
proc PB_CMD_comandos_iniciales { } {
#=============================================================
MOM_output_literal "PLANE RESET STAY"
MOM_output_literal "CYCL DEF 7.0 PUNTO CERO"
MOM_output_literal "CYCL DEF 7.1 X+0."
MOM_output_literal "CYCL DEF 7.2 Y+0."
MOM_output_literal "CYCL DEF 7.3 Z+0."
#MOM_output_literal ";=============================="
#MOM_output_literal "; POSICION DE SEGURIDAD CON M91"
#MOM_output_literal "   Q5=-1; POS SEG X"
#MOM_output_literal "   Q6=-1; POS SEG Y"
#MOM_output_literal "  Q7=-1; POS SEG Z"
#MOM_output_literal ";=============================="
...
#=============================================================
proc PB_CMD_config_cycle_start_10 { } {
#=============================================================
}


#=============================================================
proc PB_CMD_config_cycle_start_2 { } {
#=============================================================
}


#=============================================================
proc PB_CMD_config_cycle_start_3 { } {
#=============================================================
}


#=============================================================
proc PB_CMD_config_cycle_start_4 { } {
#=============================================================
}


#=============================================================
proc PB_CMD_config_cycle_start_5 { } {
#=============================================================
}


#=============================================================
proc PB_CMD_config_cycle_start_6 { } {
#=============================================================
}


#=============================================================
proc PB_CMD_config_cycle_start_7 { } {
#=============================================================
}


#=============================================================
proc PB_CMD_config_cycle_start_8 { } {
#=============================================================
}


#=============================================================
proc PB_CMD_config_cycle_start_9 { } {
#=============================================================
}
...
#=============================================================
MOM_output_literal "entro en este linear move"
}
...
# 06-18-2013 Jason - Initial version
  ...
  global mom_ude_datum_option
  set mom_ude_datum_option "CYCL 247"
...
global mom_Activar_tol_32
global mom_valor_tol
global mom_hsc mom_post_in_simulation
#MOM_output_literal "$mom_Activar_tol_32"
if [info exists mom_Activar_tol_32] {
  if { $mom_Activar_tol_32 == "ACTIVE" } {
        set val_tol [format "%2.2f" $mom_valor_tol]
...
#This command is used to get feed value and define feed rate in variables.
    #and PB_CMD_define_feedrate_format which is called from PB_CMD_before_motion.
    global mom_siemens_feed_value mom_seqnum mom_operation_type
    global mom_siemens_feed_block mom_siemens_feed_output_block
    global mom_siemens_feed_output_seqnum feed_definition
    global mom_siemens_feed_definition mom_user_feed_value
    MOM_output_literal "; ========================="
    MOM_output_literal "; PARAMETROS DE CORTE"

    if { [info exists mom_siemens_feed_definition] && $mom_siemens_feed_definition == "ON" } {
        if {![string compare "Hole Making" $mom_operation_type] || ![string compare "Point to Point" $mom_operation_type] || \
          ![string compare "Drilling" $mom_operation_type] } {
             PB_CMD_get_feed_value
             #MOM_output_literal "FN 0:Q1651=$mom_user_feed_value(engage) ;(Avance de entrada)"
             #MOM_output_literal "FN 0:Q1652=$mom_user_feed_value(first_cut) ;(Avance de primer corte)"
             MOM_output_literal "FN 0:Q1652=$mom_user_feed_value(cut) ;(Avance de trabajo)"
             #MOM_output_literal "FN 0:Q1654=$mom_user_feed_value(traversal) ;(Avance de transversal)"
             #MOM_output_literal "FN 0:Q1655=$mom_user_feed_value(retract) ;(Avance de salida)"
        } else {
             PB_CMD_get_feed_value
             MOM_output_literal "FN 0:Q1651=$mom_user_feed_value(engage) ;(Avance de entrada)"
             MOM_output_literal "FN 0:Q1652=$mom_user_feed_value(first_cut) ;(Avance de primer corte)"
             MOM_output_literal "FN 0:Q1653=$mom_user_feed_value(cut) ;(Avance de trabajo)"
             MOM_output_literal "FN 0:Q1654=$mom_user_feed_value(traversal) ;(Avance de transversal)"
             MOM_output_literal "FN 0:Q1655=$mom_user_feed_value(retract) ;(Avance de salida)"
             MOM_output_literal "FN 0:Q1656=$mom_user_feed_value(approach) ;(Avance de aproximacion)"
        }
    }
...
# string value.
  ...
  global mom_ude_feed_engage_var
  global mom_ude_feed_retract_var
  global mom_ude_feed_approach_var
  ...
  if {[info exists mom_ude_feed_definition] && $mom_ude_feed_definition == "ON"} {
     ...
     switch $motion_type {
        "cut" -
        "firstcut" -
        "stepover" { set mom_user_feed "Q1652"}
        "engage" { set mom_user_feed "Q1651"}
        "retract" { set mom_user_feed "Q1652" }
        "approach" { set mom_user_feed "Q1656" }
        default {
...
#=============================================================
proc PB_CMD_define_feedrate_format_drill { } {
#=============================================================
# This command is used to redefine feedrate output format as string and record feedrate
# value.
# Using mom_sinumerik_feed instead of feed for output in NX7.0. feed cannot be set to a
# string value.
  ...
  global mom_ude_feed_retract_var
  global mom_user_feed
  global feed mom_siemens_feed_definition
  global mom_output_unit
  global prev_motion_type mom_nxt_motion_type mom_operation_type
...

     switch $motion_type {
        "cut" -
        "firstcut" -
        "stepover" { set mom_user_feed "Q1653"}
        "engage" { set mom_user_feed "Q1653"}
        "retract" { set mom_user_feed "Q1654"}
        "rapid" {
            if { $prev_motion_type == "DEPARTURE"} {
                 set mom_user_feed "MAX"
                } else {
                   set mom_user_feed "MAX"
                }
              }
        "approach" { set mom_user_feed "MAX" }
        "departure" { set mom_user_feed "MAX"}
        default {
           # set mom_sinumerik_feed 0
           #MOM_set_address_format F Feed
           set mom_user_feed "MAX"
    ...
    set prev_motion_type $mom_motion_type
}
}
...
#=============================================================
proc PB_CMD_define_fixture_csys_1 { } {
#=============================================================
# This command is used to define the fixture coordinate system
# Three output styles are supported: cycle 7, cycle 7# and cycle 247
#
...
#=============================================================
proc PB_CMD_desact_init { } {
#=============================================================
###############################################################
#
# Comando personalizado para quitar el flag de sacar inicial
#
###############################################################

global inicio_seguridad

set inicio_seguridad 0
}


#=============================================================
proc PB_CMD_desact_init_1 { } {
#=============================================================
###############################################################
#
# Comando personalizado para quitar el flag de sacar inicial
...
#=============================================================
proc PB_CMD_desactivar_label_fresado_operacion { } {
#=============================================================
##############################################################
#
# Comando personalizado para desactivar mapeado de operacion
#
##############################################################

global flag_label_fresado map_lab_fresado mom_numero_label flag_param_lab
global flag_label_acabado mom_label_mill mom_label_finish mom_label_mill

#set mom_label_finish "FALSE"
MOM_enable_address F
#------------------------------------
MOM_enable_address Z Z_inicial
#------------------------------------
set flag_param_lab 0

if { ([info exists mom_label_mill]) && ($mom_label_mill == "FALSE") } { return }
set mom_label_mill "FALSE"
if {$flag_label_fresado == "2"} {
    if { [info exists mom_numero_label] } {
        #unset map_lab_fresado
        #unset mom_numero_label

        global save_initial_x         ; set save_initial_x "99999"
        global save_initial_y         ; set save_initial_y "99999"
        global save_initial_z         ; set save_initial_z "99999"

        global flag_label_entrada     ; set flag_label_entrada 0
        global flag_label_salida      ; set flag_label_salida 0
    }
}


set flag_label_acabado 0
}


#=============================================================
proc PB_CMD_detct_tap_pitch { } {
#=============================================================
global mom_motion_event mom_cycle_thread_pitch dpp_TNC_cycle_thread_pitch mom_tool_pitch mom_operation_name
   ...
   if { ![string compare "tap_move" $mom_motion_event] ||\
      ...
      if { [info exists mom_cycle_thread_pitch] } {
         ...
         if { [info exists mom_tool_pitch] } {
            ...
            #---------Warning---------
            set r [MOM_display_message "Error roscado, la hta no tiene paso definido" "Error Roscado" E "Aceptar" ]
            MOM_abort
        }
      }
    if { [info exists dpp_TNC_cycle_thread_pitch] && $dpp_TNC_cycle_thread_pitch == 0 } {
        set r [MOM_display_message "Error roscado, la hta no tiene paso definido" "Error Roscado" E "Aceptar" ]
        MOM_abort
    }
   }
...
#=============================================================
proc PB_CMD_detect_coolant_through { } {
#=============================================================
###################################################################
#
# Comando personalizado para detectar la refrigeracion interna
...
global refri
global mom_Activar_refri
global mom_Tipo_refri
global flag_refri


#MOM_output_literal "$mom_tool_coolant_through"

if {$mom_tool_coolant_through == "Yes" && $flag_refri == "FALSE"} {

           set refri "7"

   } elseif {($mom_tool_coolant_through == "No") && ($flag_refri == "FALSE")} {

           set refri "8"

   } elseif { $mom_Activar_refri == "ACTIVO" && $flag_refri == "TRUE" } {
               if {$mom_Tipo_refri == "TALADRINA_EXT"} { set refri "8"}
               if {$mom_Tipo_refri == "PASANTE"} { set refri "7"}
               if {$mom_Tipo_refri == "AIRE_EXTERNO"} { set refri "968"}
               if {$mom_Tipo_refri == "AIRE_INTERNO"} { set refri "967"}

   } elseif { $mom_Activar_refri == "INACTIVO" } {
                 set refri "9"
...
# 06-18-2013 Jason - Initial version
  ...
  if { $dpp_ge(coord_rot) !="NONE" } {
     #MOM_output_literal "$dpp_ge(coord_rot) $coord_rot_angle(2)"

     #if {$coord_rot_angle(2) == "-90" && $coord_rot_angle(1) == "0" && $coord_rot_angle(0) == "0"} {
     #       set coord_rot_angle(1) 90.0
     #}
     set dpp_ge(coord_rot_angle,0) $coord_rot_angle(2)
     set dpp_ge(coord_rot_angle,1) $coord_rot_angle(1)
     set dpp_ge(coord_rot_angle,2) $coord_rot_angle(0)
...
#=============================================================
proc PB_CMD_detect_csys_rotation_1 { } {
#=============================================================
# This command is used to detect csys rotation type and clearance plane existing status.
# Used in initial move and first move
#
...
#=============================================================
proc PB_CMD_detect_local_offset_1 { } {
#=============================================================
# This command is used to detect offset in local csys.
# Used in initial move and first move
#
...
#=============================================================
proc PB_CMD_detect_tool_path_type_1 { } {
#=============================================================
# This command is used to detect tool path type.
# Used in initial move and first move
#
...
#=============================================================
proc PB_CMD_detectar_cambio_herramienta { } {
#=============================================================
###########################################################################
#
# Comando personalizado que nos va a detectar si hay cambio de herramienta
# para posteriormente poner un movimiento lineal de seguridad
#
###########################################################################

global cm_cambio_hta
...
#=============================================================
proc PB_CMD_detectar_label_fresado { } {
#=============================================================
####################################################################
#
# Comando personalizado para detectar si hay label de fresado
# en grupo o en operacion
#
####################################################################

global mom_label_mill
if { ([info exists mom_label_mill]) && ($mom_label_mill == "FALSE") } { return }

global flag_label_fresado
global map_lab_fresado mom_numero_label

if { [info exists mom_numero_label] } {
            set flag_label_fresado "1"
       } else {
            set flag_label_fresado "2"
       }

#MOM_output_literal "$flag_label_fresado"
}


#=============================================================
proc PB_CMD_drill_condicion { } {
#=============================================================
global mom_nxt_event_count mom_system_template_type mom_nxt_motion_event mom_template_type mom_cutmthd_description
global flag_ini_cycle
if { $flag_ini_cycle == 0 } { return }

if { $mom_template_type != "hole_making"} {
    set flag_ini_cycle 1
    MOM_rapid_move
    #PB_CMD_check_plane_change_in_rapid_move
}
}
...
#=============================================================
proc PB_CMD_flag_ini_cycle_off { } {
#=============================================================
global flag_ini_cycle         ; set flag_ini_cycle 0
}


#=============================================================
proc PB_CMD_flag_ini_cycle_on { } {
#=============================================================
global flag_ini_cycle     ;  set flag_ini_cycle 1

}


#=============================================================
proc PB_CMD_forzar_MOM_eje_compensar { } {
#=============================================================
global mom_eje_compensar    ;    set mom_eje_compensar "VAXIS"
global mom_eje_trabajo    ;    set mom_eje_trabajo "YAXIS"
MOM_eje_compensar
...
#=============================================================
proc PB_CMD_forzar_MOM_ejes_paralelos { } {
#=============================================================
uplevel #0 {
MOM_ejes_paralelos
}; # uplevel
...
#=============================================================
proc PB_CMD_forzar_MOM_set_axis_y_modes { } {
#=============================================================
...
#=============================================================
proc PB_CMD_gestion_Z_label_fresado { } {
#=============================================================
#####################################################################
#
# Comando personalizado para gestionar cuando se saca
# la Z para el Label de fresado y cuando para cuando no hay Label
#
#####################################################################

global map_lab_fresado
global mom_numero_label
global mom_operation_name
global mom_motion_type


global mom_label_mill
MOM_disable_address Z_label
if { ([info exists mom_label_mill]) && ($mom_label_mill == "FALSE") } { return }

if {[info exists mom_numero_label]} {
    if {[info exists map_lab_fresado($mom_numero_label,0)]} {
            if {$mom_motion_type == "ENGAGE"} {
                #Aqui debo desactivar la direccion Z y activar Z_label
                MOM_disable_address Z
                MOM_disable_address Z_label
                #MOM_enable_address Z_label
                #MOM_force Once Z_label
               } else {
                #Aqui debo activar la dirección Z y desactivar Z_label
                MOM_disable_address Z_label
                #MOM_enable_address Z
               }
        }
...
#
  ...
  global mom_feed_approach_value mom_feed_approach_unit
  ...
  if { [info exists mom_feed_first_cut_value] } {
      if {[EQ_is_zero $mom_feed_first_cut_value]} {set mom_feed_first_cut_value $mom_feed_cut_value}
  } else {
      set mom_feed_first_cut_value $mom_feed_cut_value
  }
  if {[EQ_is_zero $mom_feed_retract_value]} {set mom_feed_retract_value $mom_feed_cut_value}

  if { [info exists mom_feed_traversal_value] } {
      if {[EQ_is_zero $mom_feed_traversal_value]} {set mom_feed_traversal_value $mom_feed_cut_value}
  } else {
      set mom_feed_traversal_value $mom_feed_cut_value
  }
 if { [info exists mom_feed_approach_value] } {
      if {[EQ_is_zero $mom_feed_approach_value]} {set mom_feed_approach_value $mom_feed_cut_value}
  } else {
      set mom_feed_approach_value $mom_feed_cut_value
  }
  ...
  set mom_user_feed_value(first_cut) [expr $unit_conversion*$mom_feed_first_cut_value]
  set mom_user_feed_value(traversal) [expr $unit_conversion*$mom_feed_traversal_value]
  set mom_user_feed_value(approach) [expr $unit_conversion*$mom_feed_approach_value]
  ...
  set mom_user_feed_value(first_cut) [format "%.2f" $mom_user_feed_value(first_cut)]
  set mom_user_feed_value(traversal) [format "%.2f" $mom_user_feed_value(traversal)]
  set mom_user_feed_value(approach) [format "%.2f" $mom_user_feed_value(approach)]
...
#=============================================================
global mom_sel_cabezal
global mom_Cinematica
global mom_activar_c
#MOM_output_literal "$mom_activar_c"
return

if { $mom_activar_c == "FALSE" } { return }

#if { $mom_sel_cabezal == "AUTOMATICO" } {
    switch $mom_Cinematica {
        "A-B" { PB_CMD_calculo_C_auto }
        "A-C" { return }
        "B-C" { return }
        default {}
    }
#} elseif { ($mom_sel_cabezal == "DIRECTO") } {
    #PB_CMD_calculo_C_directo
#}
}
...
#=============================================================
proc PB_CMD_guardar_giro_b_forzado { } {
#=============================================================
  global mom_rotation_angle b_forzado ude_rot_b;
  set b_forzado $mom_rotation_angle
  set ude_rot_b "1"
}
...
#########################################################################
#
# Maquina: Soraluce_FP10000
# Control: TNC640
# Empresa: EUSKO
# Fecha: 12/09/2017
# Programador: Ivan Gutierrez
#
###########################################################################
#
# Particularidades:
#                      - Cinematica XYZ, AB en el cabezal
#                      - Post con diferentes configuraciones
#                            Cabezal Directo: Mandrinadora
#                            Cabezal Ortogonal: AB
#
#                      - Taladrina Interna (M07), Taladrina externa (M08), Aire Interna (M967), Aoire Externa (M968) y Desactivar cualquiera (M09)
#                      - Fichero de errores *.log
#
#                    - Tiene las siguientes UDEs programadas:
#                       -
#                       -
############################################################################
...
#=============================================================
proc PB_CMD_info_avances { } {
#=============================================================
global mom_surface_speed mom_feed_per_tooth feed

if { [info exists feed] } {
    MOM_output_literal "; ========================="
    MOM_output_literal "; CONDICIONES DE CORTE"
    MOM_output_literal "; Velocidad Corte: $feed m/min"
}

if { [info exists mom_feed_per_tooth] } {
    set mom_feed_per_tooth [format "%.3f" $mom_feed_per_tooth]
    MOM_output_literal "; Avance diente: $mom_feed_per_tooth mm/diente"
}

if { [info exists mom_surface_speed] } {
    set mom_surface_speed [format "%.3f" $mom_surface_speed]
    MOM_output_literal "; Avance vuelta: $mom_surface_speed mm/rev"
}
MOM_output_literal "; ========================="
...
#=============================================================
proc PB_CMD_info_hta { } {
#=============================================================
global mom_tool_name mom_tool_description mom_holder_description
global mom_cutter_holder_libref mom_tool_holder_offset mom_tool_catalog_number

if { [info exists mom_tool_name] } {
    MOM_output_literal "; ========================="
    MOM_output_literal "; HERRAMIENTA Y PORTA"
    MOM_output_literal "; Hta: $mom_tool_name"
}

if { [info exists mom_tool_catalog_number] } {
    MOM_output_literal "; Articulo: $mom_tool_catalog_number"
}

if { [info exists mom_tool_description] } {
    MOM_output_literal "; Descrip. Hta: $mom_tool_description"
}

if { [info exists mom_holder_description] } {
    MOM_output_literal "; Porta Hta: $mom_holder_description"
}

# if { [info exists mom_tool_holder_description] } {
    # MOM_output_literal "; Articulo   $mom_tool_holder_description"
# }

if { [info exists mom_tool_holder_offset] } {
    set mom_tool_holder_offset [format "%.3f" $mom_tool_holder_offset]
    MOM_output_literal "; Tool Extension: $mom_tool_holder_offset mm"
}
MOM_output_literal "; ========================="
...
#=============================================================
proc PB_CMD_info_metodo { } {
#=============================================================
global mom_oper_method mom_stock_part mom_stock_blank mom_inside_outside_tolerances mom_stock_floor

if { [info exists mom_oper_method] } {
    MOM_output_literal "; ========================="
    MOM_output_literal "; Metodo: $mom_oper_method"
}
if { [info exists mom_stock_part]} {
    set mom_stock_part [format "%.3f" $mom_stock_part]
    MOM_output_literal "; Demasia: $mom_stock_part mm"
}
if { [info exists mom_stock_floor]} {
    set mom_stock_floor [format "%.3f" $mom_stock_floor]
    MOM_output_literal "; Demasia Suelo: $mom_stock_floor mm"
}
if { [info exists mom_inside_outside_tolerances(0)]} {
    set tol [expr $mom_inside_outside_tolerances(0)+ $mom_inside_outside_tolerances(1)]
    set tol [format "%.3f" $tol]
    MOM_output_literal "; Tolerancia: $tol mm"
}

if { [info exists mom_inside_outside_tolerances(0)]} {
    set mom_inside_outside_tolerances(0) [format "%.3f" $mom_inside_outside_tolerances(0)]
    MOM_output_literal "; InTol: $mom_inside_outside_tolerances(0) mm"
}
if { [info exists mom_inside_outside_tolerances(1)]} {
    set mom_inside_outside_tolerances(1) [format "%.3f" $mom_inside_outside_tolerances(1)]
    MOM_output_literal "; OutTol: $mom_inside_outside_tolerances(1) mm"
}
MOM_output_literal "; ========================="
...
#=============================================================
proc PB_CMD_info_oper { } {
#=============================================================
###########################################################################
#
# Comando personalizado que nos indica información sobre la operacion de
# mecanizado que se va a realizar posteriormente
#
###########################################################################
...
global mom_path_name mom_tool_number mom_tool_name
   ...
   MOM_output_literal "; ======================================================================= "
   MOM_output_literal ";OPERACION: $mom_path_name - HTA: T$mom_tool_number $mom_tool_name "
   MOM_output_literal "; ======================================================================= "
}


#=============================================================
proc PB_CMD_inicio_operacion { } {
#=============================================================
#########################################################################
#
# Comando personalizado para sacar el BKL FORM al comienzo del
# programa postprocesado
#
#########################################################################

global num_operacion
...
if {$num_operacion == "1"} {
    ...
    global blk_form
        ...
        if { $blk_form == "1"} {
            ...
            global mom_X_neg mom_X_pos mom_Y_neg mom_Y_pos mom_Z_neg mom_Z_pos

             MOM_output_literal "BLK FORM 0.1 Z X$mom_X_neg Y$mom_Y_neg Z$mom_Z_neg"
             MOM_output_literal "BLK FORM 0.2 X$mom_X_pos Y$mom_X_pos Z$mom_X_pos"

          } else {

             #MOM_output_literal "BLK FORM 0.1 Z X-100 Y-100 Z-100"
             #MOM_output_literal "BLK FORM 0.2 X100 Y100 Z100"
...
#=============================================================
   ...
   global cm_posicion_previa               ;# diy previous Z height
   global cm_return_pos             ;# returnZ incremental from top of hole
   global mom_pos                   ;# xy and especially Z of this hole
   global mom_prev_pos              ;# ditto - previous hole
   global mom_cycle_retract_to
global Profundidad_Pasada
global Diametro_Nominal
global Diametro_Pretaladrado
global Tipo_fresado
  #---------------------------------------------------------------------------------
   if { ![info exists mom_cycle_delay] } { set mom_cycle_delay 0.0 }

   if { [string match "AUTO" $mom_cycle_retract_mode] } {
      set cm_return_pos [expr $cm_posicion_previa - $mom_pos(2)] ;# calc incr retract
   } else {
      set cm_return_pos $mom_cycle_retract_to
   }
 ...
 #  }
  # set dpp_ge(cycle_clearance_plane) "TRUE"
global z_actual z_previa
set z_actual [format "%.2f" $mom_pos(2)]
set z_previa [format "%.2f" $mom_prev_pos(2)]

   if { $z_actual != $z_previa } {
      set cycle_init_flag  "TRUE"
   }
}
...
# Command to force output address in Start of path.
  MOM_force once G_motion X Y Z M_spindle F M_coolant
...
#=============================================================
proc PB_CMD_init_force_address_1 { } {
#=============================================================
# Command to force output address in Start of path.
...
proc PB_CMD_before_output { } {
#===============================================================================
# This command allows users to massage the NC data before it finally gets output.
# If present in the post, it gets executed by MOM_before_output automatically.
#
...
#
   ...
   if {$zwout > -1} {
      ...
      if { [string length $val] != 0 } {
         ...
         if { ![string compare $mom_sys_leader(Z) $mom_sys_quill_leader] } {
            set mom_sys_quill_pos $val
         } elseif { ![string compare $mom_sys_leader(Z) $mom_sys_table_leader] } {
...
#===============================================================================
# Broker command ensuring PB_CMD_before_output is executed by MOM_before_output.
#
...
proc MOM_before_output { } {
#===============================================================================
# This procedure is executed just before every NC block is to be output to
# the file.
#
# - Never overload this command!
# - Any customization should be done in PB_CMD_before_output!
...
#=============================================================
   ...
   global mom_sys_posicionamiento

   switch $mom_axis_position {
      ZAXIS {
         if { ![string compare $mom_sys_zw_mode $mom_sys_table_leader] } {
            set need_w_reset 0
        ...
        set mom_sys_posicionamiento "Z"
        if { $mom_sys_zaxis_pos != 0 } {
             ### Aqui saco la compensación de origen ###
             MOM_output_literal ";Compensar posicionamiento Z en origen:"
             MOM_output_literal "CYCL DEF 7.0 PUNTO CERO"
             MOM_output_literal "CYCL DEF 7.1 IZ[expr (1)* $mom_sys_zaxis_pos]"
             MOM_output_literal "CYCL DEF 7.2 IW[expr (-1)* $mom_sys_zaxis_pos]"
             ###########################################
        }
      ...
      WAXIS  {
         if { ![string compare $mom_sys_zw_mode $mom_sys_quill_leader] } {
            set need_w_reset 0
            set mom_sys_leader(Z) $mom_sys_table_leader
         }
         ...
         set mom_sys_posicionamiento "V"
        if { $mom_sys_zaxis_pos != 0 } {
         ### Aqui saco la compensación de origen ###
         MOM_output_literal ";Compensar posicionamiento W en origen:"
         MOM_output_literal "CYCL DEF 7.0 PUNTO CERO"
         MOM_output_literal "CYCL DEF 7.1 IZ[expr (-1)*$mom_sys_zaxis_pos]"
         MOM_output_literal "CYCL DEF 7.2 IW[expr (1)*$mom_sys_zaxis_pos]"
         ###########################################
...
#=============================================================
proc PB_CMD_introducir_comando { } {
#=============================================================
#############################################
#
# Comando personalizado para poder utilizar
# la UDE introducir comando
#
############################################

proc MOM_Introducir_comando {} {
    global mom_introducir_comando
    MOM_output_literal "$mom_introducir_comando"
}
...
#=============================================================
proc PB_CMD_listado_label_fresado { } {
#=============================================================
###################################################################
#
# Comando personalizado para sacar un listado de label
#
###################################################################

global map_lab_fresado
#MOM_output_literal "||||||||||||||| Listado Labels disponibles ||||||||||||||||"
for {set i 0} {$i < 100} { incr i 1} {
    if {[info exists map_lab_fresado($i,0)]} {
...
#=============================================================
proc PB_CMD_llamada_label_taladrado { } {
#=============================================================
################################################################
#
# Comando personalizado para sacar la llamada al label de
# taladrado
#
################################################################
...
if { [ info exists mom_label ] } {
    if { $mom_label =="TRUE" } {MOM_output_literal "CALL LBL $mom_group_name" }
...
#=============================================================
proc PB_CMD_machine_kinematics { } {
#=============================================================
# ------------------------- variables_kinematics -----------------------------
global mom_kin_rotary_axis_method     ;   set mom_kin_rotary_axis_method "ZERO"
global mom_kin_iks_usage              ;   set mom_kin_iks_usage  1

# ----------------------------- resolucion -----------------------------------
#global mom_kin_linearization_tol       ; set mom_kin_linearization_tol ".001"
#global mom_kin_machine_resolution      ; set mom_kin_machine_resolution ".001"

# ------------------------- linear_circulos_helix ----------------------------
#global mom_kin_arc_output_mode         ; set mom_kin_arc_output_mode "LINEAR"
global mom_kin_helical_arc_output_mode ; set mom_kin_helical_arc_output_mode "LINEAR"

# ------------------------------ read_ahead ----------------------------------
global mom_kin_read_ahead_next_motion  ; set mom_kin_read_ahead_next_motion "TRUE"

# ------------------------------ Avance rapido -------------------------------
global mom_kin_max_fpm                 ;set mom_kin_max_fpm "35000"
...
#=============================================================
MOM_output_literal "; ==========================="
MOM_output_literal "; ====== SORALUCE TR25 ======"
MOM_output_literal "; ==========================="
...
#=============================================================
proc PB_CMD_parada_opcional { } {
#=============================================================
############################################
#
# Comando personalizado para realizar
# una parada opcional en el programa
#
############################################
...
#=============================================================
proc PB_CMD_parametros_plane_spatial { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
   global seq mom_out_angle_pos dpp_ge

   if { $dpp_ge(toolpath_axis_num)=="5" } { return }

   if {[EQ_is_lt $mom_out_angle_pos(0) 0] || $mom_out_angle_pos(1) > "180" } {
      set seq "SEQ-"
   } else {
      set seq "SEQ+"
   }

    #if {$dpp_ge(coord_rot_angle,0) == -90 && $dpp_ge(coord_rot_angle,1) == 0 && $dpp_ge(coord_rot_angle,2) == 0} {
    #    set ::mom_out_angle_pos(0) -90
    #    set ::mom_out_angle_pos(1) 90
...
#=============================================================
proc PB_CMD_pos_inicial_Z_W { } {
#=============================================================
global mom_sys_posicionamiento mom_axis_position_value

set pos_ini_eje_parelo [format "%.2f" $mom_axis_position_value]
set cero 0
return
if { $pos_ini_eje_parelo == 0.00 } {
    MOM_output_literal "L $mom_sys_posicionamiento$cero FMAX"
} else {
    MOM_output_literal "L $mom_sys_posicionamiento$cero FMAX"
    MOM_output_literal "L $mom_sys_posicionamiento$pos_ini_eje_parelo FMAX"
}
...
#=============================================================
proc PB_CMD_posicion_final { } {
#=============================================================
###########################################################################
#
# Comando personalizado cuyo objetivo es anular el plano inclinado,
# activar en 0-0, realizar un movimiento en Z y volver a anular
#
###########################################################################
...
MOM_output_literal "L Y250 FMAX M91"
    ...
    MOM_output_literal "CYCL DEF 397 CICLO CABEZAL ~"
MOM_set_seq_off
    MOM_output_literal "   Q1507=0 ; DEGRES ART. VERT. ~"
    MOM_output_literal "   Q1506=0 ; DEGRES ART. DIAG. "
MOM_set_seq_on
MOM_output_literal "L Y800 FMAX M91"
...
# ########################################################################
#
# Comando personalizado para sacar el preset de los diferentes ceros
#
# ########################################################################
#
# 0º Debo sacar la cabecera de offset despues de cabecera
# 1º Llamo al origen en B0
# 2º Añado los Labels para cada cero
# 3º Añado los preset para los ceros
#
# ########################################################################

global flagSalidaCeros mom_post_in_simulation

if {$flagSalidaCeros == 0} {
        MOM_ask_mcs_info
        #== Salida cero pieza del operario ==
        PB_CMD_cero_pieza_operario
        #== Añado los label para los ceros ==
        PB_CMD_add_fixture
        #== Añado los preset para los ceros
        PB_CMD_add_preset
        set flagSalidaCeros 1
}
...
#=============================================================
proc PB_CMD_reload_kinematic_vars { } {
#=============================================================
global mom_kin_4th_axis_ang_off mom_kin_4th_axis_center_off mom_kin_4th_axis_direction mom_kin_4th_axis_incr_switch
global mom_kin_4th_axis_leader mom_kin_4th_axis_limit_action mom_kin_4th_axis_max_limit mom_kin_4th_axis_min_incr
global mom_kin_4th_axis_min_limit mom_kin_4th_axis_plane mom_kin_4th_axis_point mom_kin_4th_axis_rotation
global mom_kin_4th_axis_type mom_kin_4th_axis_vector mom_kin_4th_axis_zero mom_kin_5th_axis_ang_off
global mom_kin_5th_axis_center_off mom_kin_5th_axis_direction mom_kin_5th_axis_incr_switch mom_kin_5th_axis_leader
global mom_kin_5th_axis_limit_action mom_kin_5th_axis_max_limit mom_kin_5th_axis_min_incr
global mom_kin_5th_axis_min_limit mom_kin_5th_axis_plane mom_kin_5th_axis_point mom_kin_5th_axis_rotation
global mom_kin_5th_axis_type mom_kin_5th_axis_vector mom_kin_5th_axis_zero mom_kin_arc_output_mode mom_kin_arc_valid_plane
global mom_kin_clamp_time mom_kin_cycle_plane_change_per_axis mom_kin_cycle_plane_change_to_lower
global mom_kin_flush_time mom_kin_linearization_flag mom_kin_linearization_tol mom_kin_machine_resolution
global mom_kin_machine_type mom_kin_machine_zero_off mom_kin_max_arc_radius mom_kin_max_dpm mom_kin_max_fpm
global mom_kin_max_fpr mom_kin_max_frn mom_kin_min_arc_length mom_kin_min_arc_radius mom_kin_min_dpm
global mom_kin_min_fpm mom_kin_min_fpr mom_kin_min_frn mom_kin_output_unit mom_kin_pivot_gauge_off mom_kin_pivot_guage_off
global mom_kin_post_data_unit mom_kin_rapid_feed_rate mom_kin_retract_distance mom_kin_rotary_axis_method
global mom_kin_spindle_axis mom_kin_tool_change_time mom_kin_x_axis_limit mom_kin_y_axis_limit mom_kin_z_axis_limit

  MOM_reload_variable -a mom_kin_4th_axis_ang_offset
  MOM_reload_variable -a mom_kin_4th_axis_center_offset
  MOM_reload_variable -a mom_kin_4th_axis_direction
  MOM_reload_variable -a mom_kin_4th_axis_incr_switch
  MOM_reload_variable -a mom_kin_4th_axis_leader
  MOM_reload_variable -a mom_kin_4th_axis_limit_action
  MOM_reload_variable -a mom_kin_4th_axis_max_limit
  MOM_reload_variable -a mom_kin_4th_axis_min_incr
  MOM_reload_variable -a mom_kin_4th_axis_min_limit
  MOM_reload_variable -a mom_kin_4th_axis_plane
  MOM_reload_variable -a mom_kin_4th_axis_point
  MOM_reload_variable -a mom_kin_4th_axis_rotation
  MOM_reload_variable -a mom_kin_4th_axis_type
  MOM_reload_variable -a mom_kin_4th_axis_vector
  MOM_reload_variable -a mom_kin_4th_axis_zero
  MOM_reload_variable -a mom_kin_5th_axis_ang_offset
  MOM_reload_variable -a mom_kin_5th_axis_center_offset
  MOM_reload_variable -a mom_kin_5th_axis_direction
  MOM_reload_variable -a mom_kin_5th_axis_incr_switch
  MOM_reload_variable -a mom_kin_5th_axis_leader
  MOM_reload_variable -a mom_kin_5th_axis_limit_action
  MOM_reload_variable -a mom_kin_5th_axis_max_limit
  MOM_reload_variable -a mom_kin_5th_axis_min_incr
  MOM_reload_variable -a mom_kin_5th_axis_min_limit
  MOM_reload_variable -a mom_kin_5th_axis_plane
  MOM_reload_variable -a mom_kin_5th_axis_point
  MOM_reload_variable -a mom_kin_5th_axis_rotation
  MOM_reload_variable -a mom_kin_5th_axis_type
  MOM_reload_variable -a mom_kin_5th_axis_vector
  MOM_reload_variable -a mom_kin_5th_axis_zero
  MOM_reload_variable -a mom_kin_arc_output_mode
  MOM_reload_variable -a mom_kin_arc_valid_plane
  MOM_reload_variable -a mom_kin_clamp_time
  MOM_reload_variable -a mom_kin_cycle_plane_change_per_axis
  MOM_reload_variable -a mom_kin_cycle_plane_change_to_lower
  MOM_reload_variable -a mom_kin_flush_time
  MOM_reload_variable -a mom_kin_linearization_flag
  MOM_reload_variable -a mom_kin_linearization_tol
  MOM_reload_variable -a mom_kin_machine_resolution
  MOM_reload_variable -a mom_kin_machine_type
  MOM_reload_variable -a mom_kin_machine_zero_offset(0)
  MOM_reload_variable -a mom_kin_max_arc_radius
  MOM_reload_variable -a mom_kin_max_dpm
  MOM_reload_variable -a mom_kin_max_fpm
  MOM_reload_variable -a mom_kin_max_fpr
  MOM_reload_variable -a mom_kin_max_frn
  MOM_reload_variable -a mom_kin_min_arc_length
  MOM_reload_variable -a mom_kin_min_arc_radius
  MOM_reload_variable -a mom_kin_min_dpm
  MOM_reload_variable -a mom_kin_min_fpm
  MOM_reload_variable -a mom_kin_min_fpr
  MOM_reload_variable -a mom_kin_min_frn
  MOM_reload_variable -a mom_kin_output_unit
  MOM_reload_variable -a mom_kin_pivot_gauge_offset
  MOM_reload_variable -a mom_kin_pivot_guage_offset
  MOM_reload_variable -a mom_kin_post_data_unit
  MOM_reload_variable -a mom_kin_rapid_feed_rate
  MOM_reload_variable -a mom_kin_retract_distance
  MOM_reload_variable -a mom_kin_rotary_axis_method
  MOM_reload_variable -a mom_kin_spindle_axis
  MOM_reload_variable -a mom_kin_tool_change_time
  MOM_reload_variable -a mom_kin_x_axis_limit
  MOM_reload_variable -a mom_kin_y_axis_limit
  MOM_reload_variable -a mom_kin_z_axis_limit

}


#=============================================================
proc PB_CMD_renombrar_fichero { } {
#=============================================================
#############################################################################
#
# Comando personalizado para crear carpeta con el nombre de la maquina
# en el directorio seleccionado y dentro de la carpeta meter el fichero
# NC generado con el nombre de la carpeta seleccionada al postprocesar
#
##############################################################################

global mom_post_in_simulation mom_cycle_feed_to cycle_peck_size
#1. Crear carpeta, si no existe la creara.
...
global maquina mom_operation_name mom_group_name

#set carpeta [file mkdir $mom_output_file_directory/$maquina]

#2. Cerrar fichero de postprocesado
  MOM_close_output_file $mom_output_file_full_name

#3. Renombrar el fichero generado
...
#4. Mover fichero generado a la carpeta y eliminar el original
...
#=============================================================
global mom_output_mode_cmd mom_output_mode_define mom_ude_5axis_tool_path mom_cycle_option
...
#=============================================================
proc PB_CMD_reset_ciclo7 { } {
#=============================================================
global flag_comp_ciclo7


if { $flag_comp_ciclo7 == "1" } {
...
#=============================================================
proc PB_CMD_reset_final_values { } {
#=============================================================
##########################################################################
#
# Comando personalizado para resetear valores
#
##########################################################################

global mom_cambio_plano
global inicio_seguridad

if {$mom_cambio_plano == "TRUE"} { set $inicio_seguridad 1 }

set mom_cambio_plano "FALSE"

global flag_introcudir_comando    ;    set flag_introcudir_comando 0
PB_CMD_set_default_dpp_value

global flag_ini_cycle         ; set flag_ini_cycle 0

global dpp_TNC_cycle_thread_pitch    ; set dpp_TNC_cycle_thread_pitch 0
}
...
# 06-18-2013 Jason - Initial version
  ...
  global mom_next_oper_has_tool_change mom_current_oper_is_last_oper_in_program
  global dpp_ge mom_kin_arc_output_mode mom_kin_helical_arc_output_mode
  global save_mom_kin_arc_output_mode save_mom_kin_helical_arc_output_mode
  global save_mom_kin_machine_type mom_kin_machine_type mom_out_angle_pos
  global mom_prev_out_angle_pos mom_pos mom_prev_pos mom_cambio_plano tipo_op
...
global mom_cambio_plano inicio_seguridad
if {$mom_cambio_plano == "TRUE"} { set $inicio_seguridad 1 }
set mom_cambio_plano "FALSE"
...
global flag_ini_cycle                ;    set flag_ini_cycle 0
global dpp_TNC_cycle_thread_pitch    ;    set dpp_TNC_cycle_thread_pitch 0
global flag_ciclo32                  ;    set flag_ciclo32  0

global tipo_op_ant tipo_op
set tipo_op_ant $tipo_op
set tipo_op     "3ejes"

#global refri    ; set refri "9"
global mom_Tipo_ref         ;     set mom_Tipo_ref "DESACTIVAR"
global flag_cambio_cab      ;     set flag_cambio_cab "0"


global flag_tal    ;    set flag_tal 0

set ::mom_pos_alt "FALSE"

global mom_kin_4th_axis_leader mom_kin_5th_axis_leader save_4th save_5th
set save_4th $mom_kin_4th_axis_leader
set save_5th $mom_kin_5th_axis_leader
...
#=============================================================
proc PB_CMD_restaurar_direccion { } {
#=============================================================
...
#=============================================================
proc PB_CMD_salida_label_acabado { } {
#=============================================================
#######################################################################
#
# Comando personalizado para sacar el label de acabado
#
#######################################################################

global flag_label_acabado
global mom_numero_label_acabado
global mom_pos mom_nxt_pos
global map_lab_acabado
global mom_operation_name
global save_initial_x save_initial_y save_initial_z mom_nxt_pos mom_numero_label

global mom_label_finish flag_label_acabado
if { ([info exists mom_label_finish]) && ($mom_label_finish == "FALSE") } { return }
#MOM_output_literal "acabado $mom_label_finish $flag_label_acabado $mom_nxt_pos(2)"
#set nxt_z [format "%3.2f" $mom_nxt_pos(2)]

if {$flag_label_acabado == "1"} {
     MOM_output_literal "Q501 = [format "%3.2f" [expr $mom_nxt_pos(2) + $map_lab_acabado($mom_numero_label_acabado,1)]] ;PRIMERA PASADA"
     MOM_output_literal "Q502 = [format "%3.2f" [expr $mom_nxt_pos(2) + $map_lab_acabado($mom_numero_label_acabado,2)]] ;ULTIMA PASADA"
     MOM_output_literal "Q503 = [format "%3.2f" $map_lab_acabado($mom_numero_label_acabado,3)] ;PASADA"
     MOM_output_literal "Q504 = ( Q501 - Q502 ) ; PROFUNDIDAD A MECANIZAR"
     MOM_output_literal "Q505 = INT ( Q504 / Q503 ) + 1 ; NUMERO PASADAS"
     MOM_output_literal "Q507 = Q504 / Q505 ; PASADA REAL"
     MOM_output_literal "* - LBL_$mom_numero_label"

          #Añado linea de posicionamiento
              set save_initial_x $mom_pos(0)
              set save_initial_y $mom_pos(1)
              set save_initial_z $mom_pos(2)
              MOM_force Once G_motion Z_inicial FMAX
              MOM_do_template inicial_label_Z

     MOM_output_literal "CALL LBL $mom_numero_label_acabado; Llamada label $mom_numero_label_acabado de acabado"
...
#=============================================================
proc PB_CMD_salida_label_fresado { } {
#=============================================================
######################################################################
#
# comando personalizado para sacar los valores del label de fresado
#
######################################################################
global mom_pos map_lab_fresado mom_numero_label mom_operation_name
global mom_current_motion mom_motion_type mom_nxt_motion_type
global save_initial_x save_initial_y save_initial_z save_engage_z
global flag_label_entrada flag_label_salida flag_param_lab mom_user_feed
global mom_label_mill mom_post_in_simulation

#MOM_output_literal "$map_lab_fresado($mom_numero_label,0) $mom_label_mill $flag_param_lab"
if { ([info exists mom_label_mill]) && ($mom_label_mill == "FALSE") } { return }

if {$mom_label_mill == "TRUE"} {
    #MOM_output_literal ";ACT: $mom_motion_type NXT: $mom_nxt_motion_type $flag_label_salida"
    #Desactivo la F en los Labels
    #if { $mom_post_in_simulation != "CSE" } { MOM_disable_address F }

    if {[info exists mom_numero_label]} {
        if {[info exists map_lab_fresado($mom_numero_label,0)]} {
            if {$map_lab_fresado($mom_numero_label,0) == "TRUE"} {
                #1.0 Guardar movimiento inicial
                if {($mom_current_motion == "initial_move") || ($mom_current_motion == "first_move")} {
                    set save_initial_x $mom_pos(0)
                    set save_initial_y $mom_pos(1)
                    set save_initial_z $mom_pos(2)
                ...
                #2.0 Movimiento APPROACH y siguiente ENGAGE
                if {($mom_motion_type == "APPROACH") && ($mom_nxt_motion_type == "ENGAGE")} {
                    set save_engage_z $mom_pos(2)
                    MOM_abort_event
                }

                #3.0 Movimiento ENGAGE y siguiente ENGAGE (Este puede existir o no)
                if {($mom_motion_type == "ENGAGE") && ($mom_nxt_motion_type == "ENGAGE")} {
                    set flag_label_entrada 1
                    MOM_abort_event
                }

                #4.0 Movimiento ENGAGE y siguiente CUT
                if {($mom_motion_type == "ENGAGE") && (($mom_nxt_motion_type == "CUT") || ($mom_nxt_motion_type == "FIRSTCUT")) } {
                    if {$flag_param_lab == 0} {
                        global mom_label_mesg mom_label_mesg_defined
                        if { $mom_label_mesg_defined == 1 } { MOM_output_literal "$mom_label_mesg" }
                        MOM_output_literal "Q501 = [format "%3.2f" [expr $mom_pos(2) + $map_lab_fresado($mom_numero_label,1)]] ;PRIMERA PASADA"
                        MOM_output_literal "Q502 = [format "%3.2f" [expr $mom_pos(2) + $map_lab_fresado($mom_numero_label,2)]] ;ULTIMA PASADA"
                        MOM_output_literal "Q503 = [format "%3.2f" $map_lab_fresado($mom_numero_label,3)] ;PASADA MAXIMA"
                        MOM_output_literal "Q504 = ( Q501 - Q502 ) ; PROFUNDIDAD A MECANIZAR"
                        MOM_output_literal "Q505 = INT ( Q504 / Q503 ) + 1 ; NUMERO PASADAS"
                        MOM_output_literal "Q507 = Q504 / Q505 ; PASADA REAL"
                        MOM_output_literal "* - LBL_$mom_numero_label"
                        MOM_force Once G_motion Z_inicial FMAX
                        MOM_do_template inicial_label_Z
                        MOM_output_literal "LBL $mom_numero_label"
                        MOM_output_literal "Q501 = Q501 - Q507"
                        MOM_force Once G_motion X Y
                        MOM_do_template inicial_label_XY
                        if {$flag_label_entrada == 1} {
                            MOM_force Once G_motion Z_inicial FMAX
                            MOM_do_template engage_label_Z
                        }
                        global mom_user_feed
                        MOM_output_literal "L Z+Q501 FMAX"
                        set flag_param_lab 1
                    } else {
                        MOM_output_literal "L Z+Q501 FMAX"
                    }
                    MOM_do_template engage_label_XY
                    MOM_disable_address Z
                    MOM_abort_event
                }

                #5.0 Movimiento RETRACT y siguiente RETRACT (Este puede existir o no)
                if {($mom_motion_type == "RETRACT") && ($mom_nxt_motion_type == "RETRACT")} {
                    set flag_label_salida 1
                }

                #6.0 Movimiento RETRACT y siguiente DEPARTURE
                if {($mom_motion_type == "RETRACT") && ($mom_nxt_motion_type == "DEPARTURE")} {
                    MOM_force Once G_motion X Y FMAX
                    MOM_do_template retract_label_XY
                    if {$flag_label_salida == 1} {
                        MOM_force Once G_motion Z_inicial FMAX
                        MOM_do_template retract_label_Z
                    }
                    MOM_abort_event
                }

                #7.0 Movimiento DEPARTURE y siguiente rapid
                if {($mom_motion_type == "DEPARTURE") && ($mom_nxt_motion_type == "RAPID")} {
                    #MOM_force Once G_motion X Y Z FMAX
                    #MOM_do_template transicion_label_XY
                    MOM_enable_address Z
                    MOM_force Once G_motion Z FMAX
                    MOM_do_template transicion_label_Z
                    MOM_disable_address Z
                    MOM_abort_event
                }

                #7.0 Movimiento DEPARTURE y siguiente none
                if {($mom_motion_type == "DEPARTURE") && ($mom_nxt_motion_type == "none")} {
                    #MOM_enable_address Z
                    #MOM_force Once G_motion Z FMAX
                    #MOM_do_template transicion_label_Z
                    MOM_output_literal "FN 11: IF + Q501 GT +Q502 GOTO LBL $mom_numero_label"
                    MOM_force Once G_motion Z_inicial FMAX
                    MOM_do_template final_label_Z
                    MOM_output_literal "LBL 0"
                    MOM_abort_event
                }

                #7.0 Movimiento RETRACT y siguiente none
                if {($mom_motion_type == "RETRACT") && ($mom_nxt_motion_type == "none")} {
                    #MOM_enable_address Z
                    #MOM_force Once G_motion Z FMAX
                    #MOM_do_template transicion_label_Z
                    MOM_output_literal "FN 11: IF + Q501 GT +Q502 GOTO LBL $mom_numero_label"
...
#=============================================================
proc PB_CMD_salida_label_taladro { } {
#=============================================================
#####################################################################
#
# Comando personalizado para gestionar la salida del label de
# taladros
#
# A) Es la primera vez que saldra este label
# B) Ya salio previamente este label y unicamente
#    hay que volver a llamar a los puntos
# C) Hay que llamar al label donde estaban los puntos
#
#####################################################################
...
global mom_flag_label_tal
if { ([info exists mom_flag_label_tal]) && ($mom_flag_label_tal == "FALSE") } { return }

# 2º Reviso si existe label asociado a dicha geometria
if {[info exists map_tal($mom_oper_geom) ]} {
    if {[info exists sal_tal($map_tal($mom_oper_geom)) ]} {
        # 3º Examino si debo sacar llamada a label o unicamente debo llamarlo
            switch -exact -- $sal_tal($map_tal($mom_oper_geom)) {
                0 {
                    MOM_output_literal "* - LABEL $map_tal($mom_oper_geom) $mom_oper_geom "
                    MOM_output_literal "LBL $map_tal($mom_oper_geom)"
                  }
                1 {
                  }
                2 {
                    MOM_output_literal "CALL LBL $map_tal($mom_oper_geom) ;$mom_oper_geom"
                  }
                    default {
                             MOM_output_literal ";Error en label de taladro"
                            }
            }
            set sal_tal($map_tal($mom_oper_geom)) 1
...
#=============================================================
proc PB_CMD_salida_lbl100 { } {
#=============================================================
#######################################################################
#
# Comando personalizado para sacar el label 100 y compensar
# los ejes Z y W.
#
#######################################################################

global sacar_lbl100 salida_lbl100 sacar_lbl101

#MOM_output_literal "Salida de LBL 100: $sacar_lbl100"

if {$sacar_lbl100 == "1"} {
        if {$salida_lbl100 == "1"} {
            #MOM_output_literal "CALL LBL 100 ; HTA LUZERA KOMPENSATU"
           } else {
            #MOM_output_literal "*    -LBL 100 HTA LUZERA KONPENSATU"
            #MOM_output_literal "LBL 100"
            #MOM_output_literal "CYCL DEF 7.0 PUNTO CERO"
            #MOM_output_literal "CYCL DEF 7.1 Z-Q114"
            #MOM_output_literal "CYCL DEF 7.2 W+Q114"
            #MOM_output_literal "LBL 0"
            set salida_lbl100 "1"
           }
        set sacar_lbl101 "1"
...
#MOM_output_literal "Salida de LBL 100: $sacar_lbl101"
}


#=============================================================
proc PB_CMD_salida_lbl101 { } {
#=============================================================
#######################################################################
#
# Comando personalizado para sacar el label 101 y compensar
# los ejes Z y W.
#
#######################################################################

global sacar_lbl101 salida_lbl101 sacar_lbl100

if {$sacar_lbl101 == "1"} {
        if {$salida_lbl101 == "1"} {
            MOM_output_literal "CALL LBL 101 ;HTA LUZERA DESKONPENSATU"
           } else {
            MOM_output_literal "*    -LBL 101 HTA LUZERA DESKONPENSATU"
            MOM_output_literal "LBL 101"
            MOM_output_literal "CYCL DEF 7.0 PUNTO CERO"
            MOM_output_literal "CYCL DEF 7.1 Z+0"
            MOM_output_literal "CYCL DEF 7.2 W+0"
            MOM_output_literal "LBL 0"
            set salida_lbl101 "1"
           }
...
#Vuelvo a dejar por defecto las variables de sacar label
set sacar_lbl100 0
set sacar_lbl101 0
}
...
# a dedicated variable
   ...
   if { [info exists mom_pos(2)] } {
      set cm_posicion_previa $mom_pos(2)
   } else {
      set cm_posicion_previa 0           ;# irrelevant if not yet set
   }
}


#=============================================================
proc PB_CMD_select_kinematics { } {
#=============================================================
##############################################################################
#
# Comando personalizado para seleccionar la cinematica de la maquina
#
##############################################################################
...
global cinematica
        ...
        switch $cinematica {
            ...
            "B-C" {PB_CMD_update_B-C}
            "A-C" {PB_CMD_update_A-C}
            "A-B" {PB_CMD_update_A-B}
            "A-B-C" {PB_CMD_update_A-B-C}
            default {}
...
#=============================================================
proc PB_CMD_suavizado_operacion { } {
#=============================================================
#########################################################################
#
# Comando personalizado para decidir si se saca la orden M90 en los
# movimientos de mecanizado o no se sacan
#
#########################################################################

global mom_Suavizado
global mom_motion_event

if {[ info exists mom_Suavizado ] } {
    if { $mom_Suavizado == "TRUE" } {
        if { ($mom_motion_event != "initial_move") && ($mom_motion_event != "first_move") } {
            MOM_add_to_line_buffer end " M90"
        }
    }
}
}
...
#=============================================================
proc PB_CMD_tiempo_op { } {
#=============================================================
global mom_toolpath_time tiempo_total

set tiempo_op [format "%.3f" $mom_toolpath_time]

MOM_output_literal "; ========================="
MOM_output_literal "; Tiempo operacion: $tiempo_op minutos"
MOM_output_literal "; ========================="

set tiempo_total  [expr $tiempo_total + $tiempo_op]
}


#=============================================================
proc PB_CMD_tiempo_total { } {
#=============================================================
global  tiempo_total
set tiempo_total [format "%.3f" $tiempo_total]

MOM_output_literal "; ========================="
MOM_output_literal "; Tiempo total: $tiempo_total minutos"
MOM_output_literal "; ========================="
...
#=============================================================
proc PB_CMD_tipo_avance { } {
#=============================================================
global mom_motion_type tipo_avance tipo_avance_old
...
if {$mom_motion_type == "ENGAGE"} {
    ...
    if {$tipo_avance == $tipo_avance_old} {
        set tipo_avance ""
    }

    if {$mom_motion_type == "ENGAGE"} {
        set tipo_avance_old "FQ1"
    } else {
        set tipo_avance_old "FQ2"
    }


    global mom_feed_engage_value mom_motion_type mom_feed_rate
    if {$mom_motion_type == "ENGAGE"} {
        set mom_feed_engage_value $mom_feed_rate
    }
}


#=============================================================
proc PB_CMD_tipo_operacion { } {
#=============================================================
global dpp_ge tipo_op mom_tool_axis mom_nxt_out_angle_pos mom_out_angle_pos mom_prev_out_angle_pos
global modo_maq b_turn mom_tool_holder_angle_for_cutting
global mom_machine_mode mom_tool_axis mom_use_b_axis RAD2DEG prevA prevB mom_current_motion

if {$mom_current_motion == "initial_move" } {
    MOM_output_literal "L Z1300 FMAX M91"
    #MOM_output_literal "L Y250 FMAX M91"
    set prevB $mom_out_angle_pos(0)
    set prevA $mom_out_angle_pos(1)
    return
} else {
    if {![string compare $mom_machine_mode "MILL"]} {
        if { $dpp_ge(toolpath_axis_num) == "3" } {
            if { ($dpp_ge(coord_rot) != "NONE") } {
                set tipo_op "3mas2"
                MOM_enable_address fourth_axis fifth_axis
                if { $mom_out_angle_pos(0) != $mom_prev_out_angle_pos(0) || $mom_out_angle_pos(1) != $mom_prev_out_angle_pos(1)} {

                    #MOM_output_literal    "L Z1300 FMAX M91"
                    #MOM_output_literal    "L Y250 FMAX M91"
                    #MOM_output_literal    "L X0 FMAX"
                }
                if { $mom_prev_out_angle_pos(0) != "0" ||  $mom_prev_out_angle_pos(1) != "0"} {
                    #MOM_output_literal    "L Z1300 FMAX M91"
                }
            } else {
                if { [info exists mom_nxt_out_angle_pos] } {
                    if { ($mom_nxt_out_angle_pos(0) != 0) || ($mom_nxt_out_angle_pos(1) != 0) } {
                        set tipo_op "3mas2"
                    }
                } else {
                    set tipo_op "3ejes"
    ...
    if { $mom_out_angle_pos(0) != $prevB || $mom_out_angle_pos(1) != $prevA} {
        #MOM_output_literal    "L Z1300 FMAX M91"
        #MOM_output_literal    "L Y250 FMAX M91"
        #MOM_output_literal    "L X0 FMAX"
    }
    MOM_output_literal    "L Z1300 FMAX M91"
    #MOM_output_literal "$dpp_ge(toolpath_axis_num) $dpp_ge(coord_rot)------> $tipo_op $mom_nxt_out_angle_pos(0)"
    set prevB $mom_out_angle_pos(0)
    set prevA $mom_out_angle_pos(1)
...
#=============================================================
proc PB_CMD_unset_flag_mov_ini { } {
#=============================================================
global flag_mov_ini
set flag_mov_ini 0
}
...
#=============================================================
proc PB_CMD_update_A-B { } {
#=============================================================
######################################################################################
#
# Comando personalizado para poner la configuracion de la maquina A y B
#
######################################################################################
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_4th_axis_min_incr                 "2.5"
  set mom_kin_4th_axis_min_limit                "-180"
  set mom_kin_4th_axis_plane                    "ZX"
  set mom_kin_4th_axis_point(0)                 "0.0"
  set mom_kin_4th_axis_point(1)                 "0.0"
  set mom_kin_4th_axis_point(2)                 "0.0"
  ...
  set mom_kin_5th_axis_leader                   "A"
  set mom_kin_5th_axis_limit_action             "Warning"
  set mom_kin_5th_axis_max_limit                "180"
  set mom_kin_5th_axis_min_incr                 "2.5"
  set mom_kin_5th_axis_min_limit                "-180"
  ...
  set mom_kin_spindle_axis(2)                   "1.0"
  set mom_kin_tool_change_time                  "10.0"
  set mom_kin_x_axis_limit                      "10000"
  set mom_kin_y_axis_limit                      "1500"
  set mom_kin_z_axis_limit                      "3200"

MOM_enable_address fourth_axis fifth_axis
PB_CMD_reload_kinematic_vars
MOM_reload_kinematics

#MOM_output_literal ";Cinematica de Maquina A-B"
}


#=============================================================
proc PB_CMD_update_A-B-C { } {
#=============================================================
##################################################################################################
#
# Comando personalizado para poner la configuracion de la maquina A y B posicional y C continuo
#
##################################################################################################
...
#Este modo actualmente no lo tienen disponible
}


#=============================================================
proc PB_CMD_update_A-C { } {
#=============================================================
######################################################################################
#
# Comando personalizado para poner la configuracion de la maquina A y C
#
######################################################################################
global mom_kin_4th_axis_leader mom_kin_5th_axis_leader
global mom_kin_4th_axis_ang_off mom_kin_4th_axis_center_off mom_kin_4th_axis_direction mom_kin_4th_axis_incr_switch
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_pivot_guage_offset                ""
  set mom_kin_post_data_unit                    "MM"
  set mom_kin_rapid_feed_rate                   "100000"
  set mom_kin_retract_distance                  "500"
  set mom_kin_rotary_axis_method                "ZERO"
  set mom_kin_spindle_axis(0)                   "0.0"
  set mom_kin_spindle_axis(1)                   "0.0"
...
#MOM_output_literal ";Cinematica de Maquina A-C"
}


#=============================================================
proc PB_CMD_update_B-C { } {
#=============================================================
global mom_kin_4th_axis_leader mom_kin_5th_axis_leader
global mom_kin_4th_axis_ang_off mom_kin_4th_axis_center_off mom_kin_4th_axis_direction mom_kin_4th_axis_incr_switch
global mom_kin_4th_axis_leader mom_kin_4th_axis_limit_action mom_kin_4th_axis_max_limit mom_kin_4th_axis_min_incr
...
#MOM_output_literal ";Cinematica de Maquina B-C"
}


#=============================================================
proc PB_CMD_update_directo { } {
#=============================================================
######################################################################################
#
# Comando personalizado para poner la configuracion de la maquina A y B
...
#MOM_output_literal ";Cinematica de Maquina Cabezal Directo"
}


#=============================================================
proc PB_CMD_uplevel_DPP_GE_COOR_ROT_AUTO3D { } {
#=============================================================
 uplevel #0 {
 proc DPP_GE_COOR_ROT_AUTO3D { rot_matrix rot_pos } {
    ...
    #
#MOM_output_literal "entro auto3d"
       ...
       global mom_out_angle_pos mom_prev_out_angle_pos
       global DEG2RAD
       global mom_pos mom_mcs_goto mom_prev_pos mom_motion_event
...
#MOM_output_literal "; * entro aqui - $mom_motion_event - $mom_out_angle_pos(0) $mom_kin_coordinate_system_type"
       if {[info exists mom_kin_coordinate_system_type] && ![string compare "CSYS" $mom_kin_coordinate_system_type]} {
          return 0
       } else {
          if {(![EQ_is_zero $mom_out_angle_pos(0)] && ![VEC3_is_equal mom_kin_4th_axis_vector Z]) || \
            ...
            global ude_rot_b b_forzado
            if {$ude_rot_b == "1" } {

                   set mom_pos(4) $b_forzado
                   set mom_prev_pos(4) $b_forzado
                   set mom_out_angle_pos(1) $b_forzado
                   set mom_prev_out_angle_pos(1) $b_forzado
       ...
       if { [string match "5_axis_dual_head" $mom_kin_machine_type] } {
          ...
          #MOM_output_literal "Entro funcion auto3d a"
          set ang_pos(0) $mom_out_angle_pos(0)
          set ang_pos(1) $mom_out_angle_pos(1)
       }
...
#=============================================================
proc PB_CMD_uplevel_MOM_BLK_FORM { } {
#=============================================================
...
global blk_form        ; set blk_form 1
...
#=============================================================
proc PB_CMD_uplevel_MOM_Ciclo_208 { } {
#=============================================================
uplevel #0 {
proc MOM_Ciclo_208 {} {
    global mom_Profundidad_Pasada
    global mom_Diametro_Nominal
    global mom_Diametro_Pretaladrado
    global mom_Tipo_fresado

    set mom_Profundidad_Pasada [format "%.2f" $mom_Profundidad_Pasada]
    set mom_Diametro_Nominal [format "%.2f" $mom_Diametro_Nominal]
    set mom_Diametro_Pretaladrado [format "%.2f" $mom_Diametro_Pretaladrado]
    set mom_Tipo_fresado [format "%.2f" $mom_Tipo_fresado]
}
}; # uplevel
}
...
#=============================================================
proc PB_CMD_uplevel_MOM_Refrigerante_EUSKO { } {
#=============================================================
    global mom_Tipo_ref
    global mom_texto_refrigeracion
    global flag_refri
uplevel #0 {
proc MOM_Refrigerante_EUSKO {} {
    global mom_Tipo_ref
    global mom_texto_refrigeracion
    global flag_refri
    set flag_refri "TRUE"
...
#=============================================================
proc PB_CMD_uplevel_MOM_catch_warning { } {
#=============================================================
######################################################################################
#
# Comando personalizado para la gestion de la cinematica de la maquina
#
######################################################################################
...
#=============================================================
proc PB_CMD_uplevel_MOM_ciclo_32 { } {
#=============================================================
######################################################################################
#
# Comando personalizado para la gestion de ciclo32
#
######################################################################################
uplevel #0 {
proc MOM_ciclo_32 {} {
    ...
    global mom_hsc
        ...
        set mom_valor_tol [format "%.2f" $mom_valor_tol]

        global flag_ciclo32    ;    set flag_ciclo32 1
}
}; # uplevel
...
#=============================================================
proc PB_CMD_uplevel_MOM_creacion_label_taladro { } {
#=============================================================
uplevel #0 {

#=============================================================
proc MOM_creacion_label_taladro { } {
#=============================================================

####################################################################################
#
# Comando personalizado para gestionar los labels de taladros
#
####################################################################################
#
# Mapeado: $map_tal(geometria_padre)
#          $sal_tal(numero_de_taladro)
#
# geometria_padre = $mom_oper_geom
# sal_tal: 0 No ha salido aun el ciclo
#          1 Estan saliendo los puntos
#          2 Ciclo sacado pero no estan saliendo puntos
#
######################################################################################
...
global sal_tal
global sup_puntos_tal
global save_num_flag_tal
#if { $save_num_flag_tal  != $mom_num_label_tal } {
#MOM_output_literal "map_tal($mom_oper_geom) $mom_oper_geom $mom_num_label_tal save $save_num_flag_tal"
#}
if { ![info exists map_tal($mom_oper_geom) ]} {

        set map_tal($mom_oper_geom) $mom_num_label_tal
        set sal_tal($map_tal($mom_oper_geom)) 0
        set sup_puntos_tal($map_tal($mom_oper_geom)) 0
        #MOM_output_literal "Añadido mapeado de taladro: $map_tal($mom_oper_geom) y salida: $sal_tal($mom_num_label_tal)"


        set save_num_flag_tal $mom_num_label_tal
 }
...
#=============================================================
proc PB_CMD_uplevel_MOM_eje_compensar { } {
#=============================================================
uplevel #0 {
proc MOM_eje_compensar {} {
# Set Axis elegimos ejes paralelos
# Set modes elegimos eje trabajo
    global mom_eje_compensar mom_pos_ini_eje_paralelo reposicion
    global mom_parallel_to_axis compenso_axis flag_reposicion cero
    global flag_transicion mom_eje_compensar mom_axis_position
    global mom_sys_posicionamiento flag_posicionar_cero valor_inicial_pos
    global mom_axis_position_value mom_sys_quill_leader mom_sys_table_leader
    global mom_sys_zw_mode mom_sys_leader mom_eje_trabajo
    if { $mom_eje_trabajo == "YAXIS" } {
        # Set Axis
        set mom_axis_position "VAXIS"
        set mom_axis_position_value $mom_pos_ini_eje_paralelo

        # Set Modes
        set mom_parallel_to_axis "YAXIS"

        set compenso_axis "Y"
        set mom_sys_posicionamiento "V"

        set reposicion "0"
        set valor_inicial_pos "0"
        set flag_reposicion "FALSE"

        set mom_sys_quill_leader    "V"
        set mom_sys_table_leader    "Y"
        set mom_sys_zw_mode         $mom_sys_quill_leader
        #set mom_sys_leader(z_axis)  $mom_sys_quill_leader
        set mom_sys_leader(Z) $mom_sys_table_leader


    } elseif { $mom_eje_trabajo == "VAXIS" } {
        # Set Axis
        set mom_axis_position "YAXIS"
        set mom_axis_position_value $mom_pos_ini_eje_paralelo

        # Set Modes
        set mom_parallel_to_axis "VAXIS"

        set compenso_axis "V"
        set mom_sys_posicionamiento "Y"
...
#=============================================================
proc PB_CMD_uplevel_MOM_ejes_paralelos { } {
#=============================================================

uplevel #0 {

#=============================================================
proc MOM_ejes_paralelos { } {
#=============================================================

####################################################################################
#
# Comando personalizado para gestionar los ejes paralelos
#
####################################################################################
    ...
    if {$mom_modo_eje == "W"} {
        #MOM_output_literal ";Operacion con eje W"
        MOM_disable_address Z
        MOM_disable_address W
        MOM_enable_address ZW
        MOM_enable_address WZ
        #set sacar_lbl100 "1"

    } elseif {$mom_modo_eje == "Z"} {
        #MOM_output_literal ";Operacion con eje Z"
        MOM_disable_address ZW
        MOM_disable_address WZ
        MOM_enable_address Z
        MOM_enable_address W

    } elseif {$mom_modo_eje == "SIN_PARALELOS"} {
        #MOM_output_literal ";Operacion con eje Z anulando V"
        MOM_disable_address ZW
        MOM_disable_address WZ
        MOM_disable_address W
        MOM_enable_address Z
...
#=============================================================
proc PB_CMD_uplevel_MOM_linear_move { } {
#=============================================================
...
#=============================================================
   ...
   global first_linear_move mom_motion_type mom_user_feed mom_feed_rate
...
#=============================================================
proc PB_CMD_uplevel_MOM_modo_maquina { } {
#=============================================================
######################################################################################
#
# Comando personalizado para la gestion de la cinematica de la maquina
...
proc MOM_modo_maquina { } {
    ...
    if { $mom_sel_cabezal  == "AUTOMATICO" } {
        ...
        set valor_q1534 "1"
        PB_CMD_update_directo

    } elseif { $mom_sel_cabezal == "SIN_CABEZAL" } {
        set valor_q1534 "0"
        #PB_CMD_update_directo
    }

    PB_call_macro CYCL_390
    global flag_cambio_cab ; set flag_cambio_cab "1"
}
}; # uplevel
...
#=============================================================
proc PB_CMD_uplevel_MOM_rapid_move { } {
#=============================================================
...
####################################################################################
#
# Comando personalizado para gestionar los movimientos en rapido
#
####################################################################################
   ...
   PB_CMD_salida_label_fresado
     ...
     if {($mom_current_motion == "initial_move") || ($mom_current_motion == "first_move") } {
        if {$flag_label_acabado == "1"} {
            MOM_force Once G_motion Z_inicial FMAX Z
            MOM_do_template rapid_z_move
        } else {
            if {$mom_tool_axis(0) == 1 || $mom_tool_axis(0) == -1 || $mom_tool_axis(1) == 1 || $mom_tool_axis(1) == -1 || $mom_tool_axis(2) == 1 || $mom_tool_axis(2) == -1} {
                MOM_force Once G_motion Z_inicial FMAX Z
                MOM_do_template rapid_z_move
                MOM_do_template rapid_move_xy
                #MOM_do_template rapid_z_move
                ...
                MOM_force Once G_motion Z_inicial FMAX Z
                MOM_do_template rapid_move_xyz
                #MOM_do_template rapid_z_move
            }
        }
    } else {
        #MOM_force Once G_motion X Y Z_inicial FMAX
        #MOM_do_template rapid_xyz
        MOM_force Once G_motion FMAX Z
        MOM_do_template rapid_z
        MOM_force Once G_motion FMAX X Y
...
proc ATS_ajustar_angulo_A {angulo} {
    # Ajustar el ángulo para que esté dentro del rango [-225, 45]
    set angulo_modificado $angulo

    # Ajusta a [-225, 45]
    if {$angulo_modificado > 45} {
        set angulo_modificado [expr {$angulo_modificado - 360}]
    } elseif {$angulo_modificado <= -225} {
        set angulo_modificado [expr {$angulo_modificado + 360}]
    }

    return $angulo_modificado
}

proc ATS_ajustar_angulo_B {angulo} {
    # Ajustar el ángulo para que esté dentro del rango [-225, 45]
    set angulo_modificado $angulo

   # Asegúrate de que el ángulo esté en el rango de [0, 360)
    if {$angulo_modificado < 0} {
        set angulo_modificado [expr {$angulo_modificado + 360}]
    }
...
proc MOM_Introducir_comando { } {
    global flag_introducir_comando mom_introducir_comando introducir_comando i_com
    set flag_introducir_comando 1

    set introducir_comando($i_com) $mom_introducir_comando
    #MOM_output_literal "$introducir_comando($i_com)"
    incr i_com
}
...
#
#<Jul-10-2018 gsl> 9178679 - To accommodate linked posts situation
#
   set kin_list { mom_sys_4th_axis_has_limits   mom_sys_5th_axis_has_limits  mom_kin_machine_type \
                  mom_kin_4th_axis_ang_offset   mom_kin_arc_output_mode      mom_kin_4th_axis_direction \
                  mom_kin_4th_axis_incr_switch  mom_kin_4th_axis_leader      mom_kin_4th_axis_limit_action \
  ...
  #
   ...
   if { [info exists ::CURRENT_HEAD] && $::CURRENT_HEAD != "" && [info exists ::mom_sys_postname($::CURRENT_HEAD)] } {
        # MOM_output_to_listing_device "CURRENT_HEAD $::CURRENT_HEAD "
        # MOM_output_to_listing_device "CURR_POST mom_sys_postname $::mom_sys_postname($::CURRENT_HEAD)"
      ...
      if { [info exists mom_sys_leader(fifth_axis_home)]  && ![info exists ${CURR_POST}::save_mom_sys_leader(fifth_axis_home)] } {
        ...
        # MOM_output_to_listing_device "entro2"
        # MOM_output_to_listing_device "1 kin_list $kin_list"
      foreach kin_var $kin_list {
         global $kin_var save_$kin_var
         if { [info exists $kin_var] && ![info exists save_$kin_var]} {

            # MOM_output_to_listing_device "1 kin_var [set $kin_var]"
            set save_$kin_var [set $kin_var]
         }
      }

      # MOM_output_to_listing_device "2 kin_array_list $kin_array_list"
      foreach kin_var $kin_array_list {
         global $kin_var save_$kin_var
         if { [array exists $kin_var] && ![array exists save_$kin_var] } {
            set save_var save_$kin_var
            # MOM_output_to_listing_device "2 kin_var $kin_var"
            VMOV 3 $kin_var $save_var
            # MOM_output_to_listing_device "2 save_var $save_var"
         }
      }
...
# MOM_output_literal "S save_mom_kin_machine_type $save_mom_kin_machine_type"
}
...
# 05-20-2014 lili - remove out mom_kin_arc_output_mode and mom_kin_helical_arc_output_mode, they affect the compressor mode.
# 07-31-2015 szl  - PR6988503 remove mom_kin_helical_arc_output_mode
...
# return
 ...
 #MOM_output_to_listing_device "R save_mom_kin_machine_type $save_mom_kin_machine_type"
 #MOM_output_literal "R save_mom_kin_machine_type $save_mom_kin_machine_type"
...
#=============================================================
    MOM_force Once M_coolant
    MOM_do_template cycle_off_off
    PB_CMD_cancelar_label_tal


   #PB_CMD_cambio_fichero
   #PB_CMD_restaurar_direccion
   #PB_CMD_llamada_label_taladrado
}
...
#=============================================================
  global cycle_init_flag
  global mom_cycle_tool_axis_change
  global mom_cycle_clearance_plane_change mom_system_template_type
...
#=============================================================
   ...
   PB_CMD_salida_label_taladro

   if { [PB_CMD__check_block_cycle_rapid_to] } {
      MOM_force Once G_motion X Y Text Text
      MOM_do_template cycle_parameters_1
      #PB_call_macro CYCL_CALL
...
#=============================================================
proc PB_CMD_uplevel_creacion_label_acabado { } {
#=============================================================
uplevel #0 {

#=============================================================
proc MOM_creacion_label_acabado { } {
#=============================================================

####################################################################################
#
# Comando personalizado para gestionar el label de fresado
#
# Mapeado de variables: map_lab_fresado($mom_numero_label,0) == TRUE
#                       map_lab_fresado($mom_numero_label,1) == $mom_pasada_inicial
#                       map_lab_fresado($mom_numero_label,2) == $mom_pasada_final
#                       map_lab_fresado($mom_numero_label,3) == $mom_pas_max
#                       map_lab_fresado($mom_numero_label,4) == 1;carpeta 2;operacion
#
####################################################################################

#global mom_numero_label mom_pas_max mom_pasada_final mom_pasada_inicial
#global flag_label_fresado

#    set map_lab_fresado($mom_numero_label,0) "TRUE"
#    set map_lab_fresado($mom_numero_label,1) $mom_pasada_inicial
#    set map_lab_fresado($mom_numero_label,2) $mom_pasada_final
#    set map_lab_fresado($mom_numero_label,3) $mom_pas_max
#    set map_lab_fresado($mom_numero_label,4) $flag_label_fresado

####################################################################################
#
# Comando personalizado para gestionar el label de acabado
#
# Mapeado de variables: map_lab_acabado($mom_numero_label_acabado,0) == TRUE
#
####################################################################################

global map_lab_acabado
global mom_numero_label_acabado
global mom_pas_max_acabado
global mom_pasada_final_acabado
global mom_pasada_inicial_acabado
global flag_label_acabado
global map_lab_fresado
global mom_numero_label

global mom_label_finish
#MOM_output_literal "$mom_label_finish"
if { ([info exists mom_label_finish]) && ($mom_label_finish == "FALSE") } { return }

    set map_lab_acabado($mom_numero_label_acabado,0) "TRUE"


    if { [info exists map_lab_fresado($mom_numero_label,0)]} {

            #set map_lab_acabado($mom_numero_label_acabado,0) "TRUE"
            set map_lab_acabado($mom_numero_label_acabado,1) $mom_pasada_inicial_acabado
            set map_lab_acabado($mom_numero_label_acabado,2) $mom_pasada_final_acabado
            set map_lab_acabado($mom_numero_label_acabado,3) $mom_pas_max_acabado
            set map_lab_acabado($mom_numero_label_acabado,4) $map_lab_fresado($mom_numero_label_acabado,4)
            set flag_label_acabado 1

       } else {

            set ventana_grafica [MOM_display_message "No existe un label de fresado asociado al acabado.\nPor favor revise el navegador de operaciones\ny vuelva a postprocesar" "Error mapeado label" W "Aceptar" ]
...
#=============================================================
proc PB_CMD_uplevel_creacion_label_fresado { } {
#=============================================================
uplevel #0 {

#=============================================================
proc MOM_creacion_label_fresado { } {
#=============================================================
...
global mom_label_mill
#MOM_output_literal "$mom_label_mill"
if { ([info exists mom_label_mill]) && ($mom_label_mill == "FALSE") } { return }
...
#=============================================================
proc PB_CMD_uplevel_creacion_label_fresado_old { } {
#=============================================================
...
global mom_label_mesg mom_label_mesg_defined
if {[info exist mom_label_mesg_defined] && ($mom_label_mesg_defined == 1)} {
    if {[info exist mom_label_mesg]} {
        set map_lab_fresado($mom_numero_label,4) $mom_label_mesg
        set map_lab_fresado($mom_numero_label,5) "TRUE"
    } else {
        set map_lab_fresado($mom_numero_label,5) "FALSE"
    }
}  else {
        set map_lab_fresado($mom_numero_label,5) "FALSE"
}
...
#=============================================================
proc PB_CMD_uplevel_refrigeracion { } {
#=============================================================
uplevel #0 {

#=============================================================
proc MOM_Refrigeracion { } {
#=============================================================
  global mom_Activar_refri
  global mom_Tipo_refri
  global flag_refri        ; set flag_refri "TRUE"
...
#=============================================================
proc PB_CMD_valores_giro_cabezal { } {
#=============================================================
global mom_sel_cabezal A B C mom_out_angle_pos mom_Cinematica mom_tool_axis mom_alt_pos flag_comp_ciclo7
global ats_save_4th_angle ats_save_5th_angle ats_planesaptial_text seq ats_mom_out_pos


#if {$ats_save_5th_angle != $mom_out_angle_pos(0) || $ats_save_4th_angle != $mom_out_angle_pos(1)} {
    if { $mom_out_angle_pos(1) > "180"} {
        MOM_output_literal "L Y300 FMAX M91"
        MOM_output_literal "CYCL DEF 397 CICLO CABEZAL ~"
        MOM_set_seq_off
        MOM_output_literal "   Q1507=0 ; DEGRES ART. VERT. ~"
        MOM_output_literal "   Q1506=-180; DEGRES ART. DIAG. "
...
if { $::mom_pos_alt == "TRUE" } {
        ...
        MOM_output_literal "CYCL DEF 397 CICLO CABEZAL ~"
        MOM_set_seq_off
       # MOM_output_literal "   Q1507=[format "%.2f" $mom_out_angle_pos(1)] ; DEGRES ART. VERT. ~"
       # MOM_output_literal "   Q1506=[format "%.2f" $mom_out_angle_pos(0)] ; DEGRES ART. DIAG. "
        MOM_output_literal "   Q1507=[format "%.2f" $ats_mom_out_pos(0)] ; DEGRES ART. VERT. ~"
        MOM_output_literal "   Q1506=[format "%.2f" $ats_mom_out_pos(1)] ; DEGRES ART. DIAG. "
        MOM_set_seq_on
        set ats_planesaptial_text "STAY COORD ROT"
        #set ats_planesaptial_text "STAY $seq COORD ROT"
} else {
        set ats_planesaptial_text "STAY $seq COORD ROT"
}
...
set A "+Q120"
set B "+Q121"
set ats_save_4th_angle $mom_out_angle_pos(1)
set ats_save_5th_angle $mom_out_angle_pos(0)
...
#=============================================================
proc PB_CMD_variables_iniciales { } {
#=============================================================
global maquina              ; set maquina "Soraluce_FP10000"
global tipo_op              ; set tipo_op "3ejes"

# flags
global flag_mov_ini         ; set flag_mov_ini 0
global flagSalidaCeros        ; set flagSalidaCeros "0"
global flag_cambio_cab ; set flag_cambio_cab "0"
global flag_ini_cycle         ; set flag_ini_cycle 0
...
global B    ;     set B 0
global C    ;     set C 0
global save_4th     ; set save_4th 0
global save_5th     ; set save_5th 0
global save_c       ; set save_c 1111

#Variables retirar posicion seguridad
global mom_ini_op           ; set mom_ini_op "FALSE"
global mom_fin_op           ; set mom_fin_op "FALSE"

global num_operacion        ; set num_operacion 0
global blk_form             ; set blk_form 0

# UDE modo_maquina
global mom_Cinematica        ; set mom_Cinematica  "A-B"
global mom_sel_cabezal       ; set mom_sel_cabezal "AUTOMATICO"
global valor_q1534           ; set valor_q1534     "2"
global valor_q121            ; set valor_q121      "+Q121"
global valor_q120            ; set valor_q120      "+Q120"
global mom_activar_c         ; set mom_activar_c   "FALSE"

# UDE Ciclo 32
global mom_Activar_tol_32    ; set mom_Activar_tol_32 "FALSE"
global mom_valor_tol         ; set mom_valor_tol      "0.03"
global mom_hsc               ; set mom_hsc            "0"
global flag_ciclo32          ; set flag_ciclo32        0

# UDE M90
global mom_Suavizado         ; set mom_suavizado "FALSE"

# UDE Taladrina
global mom_coolant_status         ; set mom_coolant_status      "ON"
global mom_Activar_refri          ; set mom_Activar_refri       "ACTIVAR"
global mom_Tipo_refri             ; set mom_Tipo_refri          "EXTERNA"
global flag_refri                 ; set flag_refri              "FALSE"
global mom_Tipo_ref               ; set mom_Tipo_ref            "DESACTIVAR"
global mom_texto_refrigeracion    ; set mom_texto_refrigeracion ""
global refri                      ; set refri                   "09"

# UDE Ciclo 208
global mom_Profundidad_Pasada        ; set mom_Profundidad_Pasada    "0.00"
global mom_Diametro_Nominal          ; set mom_Diametro_Nominal      "0.00"
global mom_Diametro_Pretaladrado     ; set mom_Diametro_Pretaladrado "0.00"
global mom_Tipo_fresado              ; set mom_Tipo_fresado          "1"

#
global mom_cambio_plano      ; set mom_cambio_plano "FALSE"
global inicio_seguridad      ; set inicio_seguridad 0
global cm_return_pos     ;    set cm_return_pos 0


# UDE ciclo 322
global mom_decalaje_x    ; set mom_decalaje_x       "0"
global mom_decalaje_ram  ; set mom_decalaje_ram     "0"
global mom_decalaje_vert ; set mom_decalaje_vert    "0"
global mom_q1585         ; set mom_q1585            "1"
global mom_pos_mesa      ; set mom_pos_mesa         "0"
global mom_pos_seg       ; set mom_pos_seg          "1000"
global mom_q1587         ; set mom_q1587            "1"

global mom_label_mill         ; set mom_label_mill    "FALSE"
global mom_label_finish       ; set mom_label_finish  "FALSE"
global mom_flag_label_tal     ; set mom_flag_label_tal "FALSE"
global save_num_flag_tal      ; set save_num_flag_tal 0


global angulo_save
global tipo_refri          ; set tipo_refri "M09"
global flag_tal            ; set flag_tal 0
global desact_cycl7        ; set desact_cycl7 0

global sacar_lbl100        ; set sacar_lbl100 0
global sacar_lbl101        ; set sacar_lbl101 0
global salida_lbl100       ; set salida_lbl100 0
global salida_lbl101       ; set salida_lbl101 0

global mom_modo_eje         ; set mom_modo_eje "SIN_PARALELOS"

global nombre_cabezal        ; set nombre_cabezal "AUTOMATICO"
global cabezal_uso          ; set cabezal_uso 1

global map_tal
global sal_tal
global sup_puntos_tal

global flag_label_fresado    ; set flag_label_fresado "1"

global save_fijacion         ; set save_fijacion "-1"

global cambio_hta_cabezal    ; set cambio_hta_cabezal "0"

global mom_vel_hus            ; set mom_vel_hus    "0"
global mom_vel_corte          ; set mom_vel_corte  "0"
...
global flag_label_entrada      ; set flag_label_entrada 0
global flag_label_salida      ; set flag_label_salida 0
global save_engage_z          ; set save_engage_z "99999"

global map_lab_fresado

global flag_param_lab         ; set flag_param_lab 0

global flag_label_acabado    ; set flag_label_acabado 0

global mom_label_mesg    ; set mom_label_mesg " "
global mom_label_mesg_defined ; set mom_label_mesg_defined 0
...
# SISTEMA
global extension                           ;    set extension      ".h"

# FUNCIONAMIENTO
global eje_hta                             ;    set eje_hta         "Z"
global rotacion_b                          ;    set rotacion_b        "0"
global rotacion_c                          ;    set rotacion_c        "0"
global cm_cambio_hta                       ;    set cm_cambio_hta     "0"
global puntos_taladrado                    ;    set puntos_taladrado  "1"
#global coord_rotation(0)                   ;    set coord_rotation(0) "0"
#global coord_rotation(1)                   ;    set coord_rotation(1) "0"
#global coord_rotation(2)                   ;    set coord_rotation(2) "0"

# LABEL
global mom_output_label
global taladros_label                      ;    set taladros_label ""
global linea                               ;    set linea          " "
global cm_label_mill                       ;    set cm_label_mill  "0"
global cm_inicial_x                        ;
global cm_inicial_y                        ;
global cm_inicial_z                        ;
#global mom_label_mill                      ;    set mom_label_mill "FALSE"
global mom_label                           ;
global cm_fixture_offset_value             ;    set cm_fixture_offset_value "0"
...
#    CYCL 208
global Profundidad_Pasada                  ;    set Profundidad_Pasada    "0"
global Diametro_Nominal                    ;    set Diametro_Nominal      "0"
global Diametro_Pretaladrado               ;    set Diametro_Pretaladrado "0"
global Tipo_fresado                        ;    set Tipo_fresado          "0"


global flag_introducir_comando    ;    set flag_introducir_comando 0
global mom_introducir_comando
global flag_stop_hta            ; set flag_stop_hta 0
global introcudir_comando       ;    set introducir_comando 0
global i_com                    ; set i_com 0


# Ejes paralelos
global mom_parallel_to_axis          ; set mom_parallel_to_axis "Zaxis"
global compenso_axis                 ; set compenso_axis "Z"
global reposicion                    ; set reposicion "0"
global flag_reposicion               ; set flag_reposicion "FALSE"
global mom_sys_posicionamiento       ; set mom_sys_posicionamiento "W"
global flag_posicionar_cero          ; set flag_posicionar_cero "TRUE"
global valor_inicial_pos             ; set valor_inicial_pos "0"
global cero                          ; set cero 0
global flag_transicion               ; set flag_transicion "FALSE"

global mom_eje_compensar        ;     set mom_eje_compensar "YAXIS"
global mom_pos_ini_eje_paralelo     ;     set mom_pos_ini_eje_paralelo 0.00
...
global mom_label_mill
global mom_numero_label
global mom_pasada_inicial
global mom_pasada_final
global mom_pas_max
...
# Avances parametrizados
global mom_siemens_feed_definition ;  set mom_siemens_feed_definition "ON"
global tipo_avance tipo_avance_old
set tipo_avance "Q2"
set tipo_avance_old "Q3"
global mom_user_feed
global mom_siemens_feed_definition mom_ude_feed_definition
global mom_user_feed_value

set mom_siemens_feed_definition "ON"
set mom_ude_feed_definition "ON"
set mom_user_feed "Q2"

# variables tiempo

global tiempo_total    ;    set tiempo_total "0"

global prevA            ;    set prevA "99"
global prevB            ;    set prevB "99"

##### UDE ROTATE#####

global mom_kin_rotary_axis_method ; set mom_kin_rotary_axis_method "ZERO"
global ude_rot_c                 ; set ude_rot_c "0"
global ude_rot_b                 ; set ude_rot_b  "0"

global b_forzado           ; set b_forzado "0"

#ude forzar pos alternativa
global mom_pos_alt ;    set mom_pos_alt "FALSE"
set seq "SEQ-"
set ::ats_planesaptial_text "STAY $seq COORD ROT"
}
...
#=============================================================
proc PB_CMD_variables_iniciales_A { } {
#=============================================================

global angulo_save
global cabezal_uso
global nombre_cabezal
global flagSalidaCeros        ; set flagSalidaCeros "0"
global tipo_refri          ; set tipo_refri "M09"
global flag_tal            ; set flag_tal 0
global desact_cycl7        ; set desact_cycl7 0
...
global flag_label_acabado    ; set flag_label_acabado 0
global ats_save_4th_angle    ; set ats_save_4th_angle "99999"
global ats_save_5th_angle    ; set ats_save_5th_angle "99999"
}


#=============================================================
proc PB_CMD_variables_post_viejos { } {
#=============================================================
##########################################################
...
global mom_pos mom_prev_pos
   ...
   if { [info exists no_update] } {
      unset no_update
   } elseif { ![string compare "CYCLE" $mom_motion_type] && ![string compare "initial_move" $mom_motion_event] } {
...
#=============================================================
   ...
   set mom_pb_macro_arr(CYCL_200) \
       [list {{CYCL DEF 200} { } { } {} 1 =} \
        {{{$mom_cycle_rapid_to} 1 4 4 1 1 8 4 Q200} \
         ...
         {Q1652 0 Q206} \
         {{$cycle_peck_size} 1 4 4 1 1 8 4 Q202} \
         {0 0 Q210} \
         {{$mom_pos(2)} 1 4 4 1 1 8 4 Q203} \
         {{$cm_return_pos} 1 4 4 1 1 8 4 Q204} \
         {{$mom_cycle_delay} 1 3 4 1 1 7 3 Q211}}]
   ...
   set mom_pb_macro_arr(CYCL_207) \
       [list {{CYCL DEF 207} { } { } {} 1 =} \
        {{{$mom_cycle_rapid_to} 1 4 4 1 1 8 4 Q200} \
         {{$mom_cycle_feed_to} 1 4 4 1 1 8 4 Q201} \
         {{$dpp_TNC_cycle_thread_pitch} 1 3 4 1 1 7 3 Q239} \
         {{$mom_pos(2)} 1 4 4 1 1 8 4 Q203} \
         {{$cm_return_pos} 1 4 4 1 1 8 4 Q204}}]
   ...
   set mom_pb_macro_arr(CYCL_209) \
       [list {{CYCL DEF 209} { } { } {} 1 =} \
        {{{$mom_cycle_rapid_to} 1 4 4 1 1 8 4 Q200} \
         ...
         {{$mom_cycle_step1} 1 4 4 1 1 8 4 Q257} \
         {{$dpp_TNC_cycle_step_clearance} 1 4 4 1 1 8 4 Q256} \
         {{$mom_cycle_orient} 1 4 4 1 1 8 4 Q336}}]

   set mom_pb_macro_arr(CYCL_262) \
       [list {{CYCL DEF 262} { } { } {} 1 =} \
        {{{$mom_heidenhain_nominal_diameter} 1 4 4 1 1 8 4 Q335} \
         {{$dpp_TNC_cycle_thread_pitch} 1 3 4 1 1 7 3 Q239} \
         {{$mom_cycle_feed_to} 1 4 4 1 1 8 4 Q201} \
         {{$mom_heidenhain_threads_per_step} 1 4 4 1 1 8 4 Q355} \
         {{$mom_heidenhain_prepos_feedrate} 1 4 4 1 1 8 4 Q253} \
         {{$mom_heidenhain_milling_type} 1 4 4 1 1 8 4 Q351} \
         {{$mom_cycle_rapid_to} 1 4 4 1 1 8 4 Q200} \
         {{$mom_pos(2)} 1 4 4 1 1 8 4 Q203} \
         {{$js_return_pos} 1 4 4 1 1 8 4 Q204} \
         {{$mom_heidenhain_milling_feedrate} 1 4 3 1 1 7 4 Q207}}]
   ...
   set mom_pb_macro_arr(CYCL_204) \
       [list {{CYCL DEF 204} { } { } {} 1 =} \
        {{{$mom_cycle_rapid_to} 1 4 4 1 1 8 4 Q200} \
         ...
         {{$mom_heidenhain_material_thickness} 1 3 4 1 1 7 3 Q250} \
         {{$mom_heidenhain_off_center_distance} 1 4 4 1 1 8 4 Q251} \
         {{$mom_heidenhain_tool_edge_height} 1 4 4 1 1 8 4 Q252} \
         {{$mom_heidenhain_prepositioning_feedrate} 1 4 4 1 1 8 4 Q253} \
         {{$mom_cycle_feed_rate} 1 4 4 1 1 8 4 Q254} \
         {0 0 Q255} \
         {{$mom_pos(2)} 1 4 4 1 1 8 4 Q203} \
         {{$cm_return_pos} 1 4 4 1 1 8 4 Q204} \
   ...
   set mom_pb_macro_arr(CYCL_206) \
       [list {{CYCL DEF 206} { } { } {} 1 =} \
        {{{$mom_cycle_rapid_to} 1 4 4 1 1 8 4 Q200} \
         {{$mom_cycle_feed_to} 1 4 4 1 1 8 4 Q201} \
         {{$dpp_TNC_cycle_tap_feed} 1 3 4 1 1 7 3 Q206} \
         {{$mom_cycle_delay} 1 3 4 1 1 7 3 Q211} \
         {{$mom_pos(2)} 1 4 4 1 1 8 4 Q203} \
         {{$cm_return_pos} 1 4 4 1 1 8 4 Q204}}]

   set mom_pb_macro_arr(CYCL_247) \
       [list {{CYCL DEF 247 FIJAR PUNTO DE REFERENCIA} { } { } {} 1 =} \
        {{{$mom_fixture_offset_value} 1 4 3 1 1 7 4 Q339}}]

   set mom_pb_macro_arr(CYCL_390) \
       [list {{CYCL DEF 390 CAMBIO CABEZALES} { } { } {} 1 =} \
        {{{$valor_q1534} 1 4 4 1 1 8 4 Q1534}}]

   set mom_pb_macro_arr(CYCL_397) \
       [list {{CYCL DEF 397 CICLO CABEZAL} { } { } {} 1 =} \
        {{{$B} 0 Q1507} \
         {{$A} 0 Q1506}}]

   set mom_pb_macro_arr(CYCL_397_2) \
       [list {{CYCL DEF 397 CICLO CABEZAL} { } { } {} 1 =} \
        {{{$B} 1 4 4 1 1 8 4 Q1507} \
         {{$A} 1 4 4 1 1 8 4 Q1506}}]

   set mom_pb_macro_arr(CYCL_397_1) \
       [list {{CYCL DEF 397 CICLO CABEZAL} { } { } {} 1 =} \
        {{{$valor_q121} 0 Q1507} \
         {{$valor_q120} 0 Q1506}}]
   ...
   set mom_pb_macro_arr(CYCL_208) \
       [list {{CYCL DEF 208} { } { } {} 1 =} \
        {{{$mom_cycle_rapid_to} 1 4 4 1 1 8 4 Q200} \
         {{$mom_cycle_feed_to} 1 4 4 1 1 8 4 Q201} \
         {Q1652 0 Q206} \
         {{$mom_Profundidad_Pasada} 1 4 4 1 1 8 4 Q334} \
         {{$mom_pos(2)} 1 4 4 1 1 8 4 Q203} \
         {{$cm_return_pos} 1 4 4 1 1 8 4 Q204} \
         {{$mom_Diametro_Nominal} 1 3 5 1 1 8 3 Q335} \
         {{$mom_Diametro_Pretaladrado} 1 4 2 1 1 6 4 Q342} \
         {1 0 Q351}}]
}
