...
#     Dual Rotary Heads.
#
#  Created by bugalde @ Thursday, October 01 2020, 11:31:44 +0200
...
#=============================================================
global B A C
global mom_sel_cabezal mom_Cinematica mom_post_in_simulation
...
#=============================================================
proc PB_CMD_eliminar_residuales { } {
#=============================================================
###########################################################################
#
...
#MOM_output_literal "STOP;CONTROLAR PARA RESIDUALES"
#MOM_output_literal "PLANE RESET STAY"
#MOM_output_literal "PLANE SPATIAL SPA+0.0 SPB+0.0 SPC+0.0 TURN FMAX COORD ROT"
#MOM_output_literal "L IZ 50 FMAX"
#MOM_output_literal "PLANE RESET STAY"
}
...
#=============================================================
global mom_tool_name mom_tool_description mom_tool_holder_description
...
if { [info exists mom_cutter_holder_libref] } {
 MOM_output_literal "; Porta Hta: $mom_cutter_holder_libref"
}
...
if { $mom_out_angle_pos(0) != $prevA || $mom_out_angle_pos(1) != $prevB} {
            MOM_output_literal    "L Z1800 FMAX M91"
            }


#MOM_output_literal "$dpp_ge(toolpath_axis_num) $dpp_ge(coord_rot)------> $tipo_op $mom_nxt_out_angle_pos(0)"
set prevA $mom_out_angle_pos(0)
set prevB $mom_out_angle_pos(1)
...
#=============================================================
global mom_sel_cabezal A B C mom_out_angle_pos mom_Cinematica
