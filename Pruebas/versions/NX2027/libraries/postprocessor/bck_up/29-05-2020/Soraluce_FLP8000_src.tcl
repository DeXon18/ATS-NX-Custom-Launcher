...
#     Dual Rotary Heads.
#
#  Created by bugalde @ Friday, May 29 2020, 09:35:43 +0200
    ...
    if { [info exists mom_siemens_feed_definition] && $mom_siemens_feed_definition == "ON" } {
        ...
        if {![string compare "Hole Making" $mom_operation_type] || ![string compare "Point to Point" $mom_operation_type] || \
          ![string compare "Drilling" $mom_operation_type] } {
             ...
             MOM_output_literal "FN 0:Q1604=$mom_user_feed_value(retract) ;(Avance de Retroceso)"
             MOM_output_literal ";"
        } else {
            PB_CMD_get_feed_value
            MOM_output_literal ";"
...
global mom_cutter_holder_libref mom_tool_holder_offset
...
if { [info exists mom_tool_holder_description] } {
 MOM_output_literal "; Descrip. Porta :  $mom_tool_holder_description"
}
