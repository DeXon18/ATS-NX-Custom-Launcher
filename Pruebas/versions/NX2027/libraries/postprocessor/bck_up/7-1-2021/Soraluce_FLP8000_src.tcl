...
#     Dual Rotary Heads.
#
#  Created by bugalde @ Thursday, January 07 2021, 11:48:49 +0100
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   ...
   if { [PB_CMD__check_block_plane_spatial_1] } {
...
#=============================================================
global mom_sel_cabezal A B C mom_out_angle_pos mom_Cinematica mom_tool_axis mom_alt_pos
...
if { $mom_tool_axis(1) > "0.999" } {
    ...
    set B   [format "%3.2f" $B]
     ...
     MOM_output_literal "CYCL DEF 7.1 IZ+146.21"
